            ...
            <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-9 gap-2 sm:gap-3">
                ...
                >
                    ...
                    <div class="w-full aspect-square rounded-xl overflow-hidden bg-gray-50 ring-1 ring-gray-100
                                ...
                                group-hover:ring-brand-300 group-hover:bg-brand-50/30 group-hover:shadow-md
                    ...
                    <!-- Name -->
                    <span class="w-full text-center text-[11px] sm:text-xs font-medium leading-snug
