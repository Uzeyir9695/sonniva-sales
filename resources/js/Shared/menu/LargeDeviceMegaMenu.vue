...
<template>
    ...
    <div class="relative" @mouseleave="activeCategory = null">
        ...
        >
            ...
            >
                <p class="flex items-center gap-3">
                    <img :src="`categories-icons/${category.code}.png?v=2`" :alt="category.name" class="w-12 h-12 object-cover rounded-lg" />
        ...
        >
            ...
            <div class="grid grid-cols-2 xl:grid-cols-3 gap-x-12 gap-y-6">
                <div v-for="sub in activeCategory.subs" :key="sub.name">
                    ...
                    >
                        <img v-if="sub.image" :src="`${sub.storage_path}/${sub.image}`" :alt="sub.name" class="w-32 h-20 mb-2 object-cover rounded-lg shadow-sm" />
