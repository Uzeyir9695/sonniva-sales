...
const _sfc_main$6 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><button class="flex items-center cursor-pointer bg-brand-400 hover:bg-brand-500 text-gray-900 font-semibold p-2.5 h-fit rounded-full transition-colors" data-v-2d56c4a0><i class="pi pi-th-large text-sm text-white" data-v-2d56c4a0></i></button>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (drawerOpen.value) {
          _push2(`<div class="fixed inset-0 z-40 bg-black/30 backdrop-blur-sm" data-v-2d56c4a0></div>`);
        } else {
          _push2(`<!---->`);
        }
        if (drawerOpen.value) {
          _push2(`<div class="fixed top-16 sm:top-20 left-0 z-50 h-[calc(100dvh-60px)] w-full sm:w-80 bg-white shadow-2xl flex flex-col" data-v-2d56c4a0><div class="bg-gray-50 shado w-full sm:w-xs flex items-center justify-between px-4 py-4 border-y border-gray-100 sm:hidden" data-v-2d56c4a0>`);
          _push2(ssrRenderComponent(_sfc_main$7, null, null, _parent));
          _push2(ssrRenderComponent(_sfc_main$8, null, null, _parent));
          _push2(`</div><div class="flex items-center gap-3 px-4 py-4 border-b border-gray-100" data-v-2d56c4a0><div class="w-8 h-8 flex items-center justify-center rounded-full cursor-pointer hover:bg-gray-100 transition-colors shrink-0" data-v-2d56c4a0><i class="pi pi-arrow-left text-gray-600 text-sm" data-v-2d56c4a0></i></div><span class="font-semibold text-gray-900 text-sm" data-v-2d56c4a0>${ssrInterpolate(currentTitle.value)}</span><button class="ml-auto w-8 h-8 flex items-center justify-center cursor-pointer rounded-full hover:bg-gray-100 shrink-0" data-v-2d56c4a0><i class="pi pi-times text-gray-400 text-sm" data-v-2d56c4a0></i></button></div><div class="small-device-menu flex-1 overflow-y-auto" data-v-2d56c4a0>`);
          if (fadeVisible.value) {
            _push2(`<div class="p-2" data-v-2d56c4a0>`);
            if (stack.value.length > 0) {
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_, _push3, _parent2, _scopeId) => {
                  if (_push3) {
                    _push3(`<i class="pi pi-th-large text-xs" data-v-2d56c4a0${_scopeId}></i> ყველას ნახვა `);
                  } else {
                    return [
            ...
            if (stack.value.length === 0) {
              ...
              ssrRenderList(currentItems.value, (item) => {
                _push2(`<div class="w-full px-5 py-2 cursor-pointer rounded-xl text-gray-800 hover:bg-gray-50 hover:text-brand-400 transition-colors" data-v-2d56c4a0><button${ssrRenderAttrs(mergeProps({
                  style: { "--p-ripple-background": "rgba(251, 191, 36, 0.3)" },
                  class: "w-full flex items-center justify-between cursor-pointer text-left"
                }, ssrGetDirectiveProps(_ctx, _directive_ripple)))} data-v-2d56c4a0><div class="flex items-center gap-x-3" data-v-2d56c4a0><img${ssrRenderAttr("src", `/categories-icons/${item.code}.png?v=${unref(CATEGORY_ICON_VERSION)}`)}${ssrRenderAttr("alt", item.name)} class="w-10 h-10 object-cover rounded-lg" data-v-2d56c4a0><span class="text-sm font-medium text-inherit" data-v-2d56c4a0>${ssrInterpolate(item.name)}</span></div><i class="pi pi-chevron-right text-xs text-inherit" data-v-2d56c4a0></i></button></div>`);
              });
              _push2(`<!--]-->`);
            } else if (stack.value.length === 1) {
              _push2(`<div class="grid grid-cols-2 gap-3" data-v-2d56c4a0><!--[-->`);
              ssrRenderList(currentItems.value, (item) => {
                _push2(`<!--[-->`);
                if (hasChildren(item)) {
                  _push2(`<div class="flex flex-col items-center text-center w-full px-2.5 py-2.5 space-y-1 cursor-pointer rounded-xl text-gray-800 shadow-sm hover:bg-gray-50 hover:text-brand-400 transition-colors" data-v-2d56c4a0>`);
                  if (item.image) {
                    _push2(`<img${ssrRenderAttr("src", `${item.storage_path}/${item.image}`)}${ssrRenderAttr("alt", item.name)} class="w-32 h-20 object-cover rounded-lg mx-auto mb-2" data-v-2d56c4a0>`);
                  } else {
                    _push2(`<!---->`);
                  }
                  ...
                  }, ssrGetDirectiveProps(_ctx, _directive_ripple)))} data-v-2d56c4a0><span class="text-sm font-medium text-inherit" data-v-2d56c4a0>${ssrInterpolate(item.name)} ${ssrInterpolate(item.items_count ? `(${item.items_count})` : item.items?.length < 1 ? "(0)" : "")}</span><i class="pi pi-chevron-right text-xs text-amber-400" data-v-2d56c4a0></i></button></div>`);
                } else {
                  _push2(ssrRenderComponent(unref(Link), mergeProps({
                    ...
                    default: withCtx((_, _push3, _parent2, _scopeId) => {
                      if (_push3) {
                        if (item.image) {
                          _push3(`<img${ssrRenderAttr("src", `${item.storage_path}/${item.image}`)}${ssrRenderAttr("alt", item.name)} class="w-32 h-20 object-cover rounded-lg mx-auto mb-2" data-v-2d56c4a0${_scopeId}>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        _push3(`<span class="text-sm font-medium" data-v-2d56c4a0${_scopeId}>${ssrInterpolate(item.name)} ${ssrInterpolate(item.items_count ? `(${item.items_count})` : "(0)")}</span>`);
                      } else {
                        return [
              ...
              ssrRenderList(currentItems.value, (item) => {
                _push2(ssrRenderComponent(unref(Link), mergeProps({
                  ...
                  default: withCtx((_, _push3, _parent2, _scopeId) => {
                    if (_push3) {
                      _push3(`<span class="text-sm font-medium text-inherit" data-v-2d56c4a0${_scopeId}>${ssrInterpolate(item.name)} ${ssrInterpolate(item.items_count ? `(${item.items_count})` : "(0)")}</span>`);
                    } else {
                      return [
...
const SmallDeviceMegaMenu = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-2d56c4a0"]]);
const _sfc_main$5 = {
  __name: "SearchBar",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=index-Jd2A288X.js.map
