...
import { ref, computed, mergeProps, withCtx, unref, openBlock, createBlock, createVNode, Fragment, renderList, withModifiers, toDisplayString, createCommentVNode, useSSRContext } from "vue";
          ...
          if (_push2) {
            if (loading.value) {
              ...
              if (selectedItems.value.length) {
                _push2(`<div${_scopeId}><p class="text-sm text-gray-500 mb-0.5"${_scopeId}>ჯამი</p><span class="font-semibold text-gray-800"${_scopeId}>${ssrInterpolate(selectedTotal.value.toFixed(2))} ₾</span></div>`);
              } else {
              ...
              loading.value ? (openBlock(), createBlock("div", {
                    ...
                    return openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "flex items-end justify-between border-t border-gray-100 pt-2 mt-auto" }, [
                        createVNode("div", null, [
                          createVNode("p", { class: "text-xs text-gray-400 mb-0.5" }, "ერთ. ფასი"),
                ...
                createVNode("div", { class: "flex items-center justify-between gap-3" }, [
                  selectedItems.value.length ? (openBlock(), createBlock("div", { key: 0 }, [
                    createVNode("p", { class: "text-sm text-gray-500 mb-0.5" }, "ჯამი"),
...
//# sourceMappingURL=ReorderDialog-BbXZUQQb.js.map
