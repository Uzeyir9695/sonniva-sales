...
import { ref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, createCommentVNode, useSSRContext } from "vue";
          ...
          if (_push2) {
            if (loading.value) {
              ...
              if (order.value.branch) {
                _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-building text-xs text-brand-400"${_scopeId}></i> Pickup: <span class="font-medium text-gray-700 ml-1 capitalize"${_scopeId}>${ssrInterpolate(order.value.branch)} Office</span></p>`);
              } else {
                _push2(`<!---->`);
              }
              if (order.value.city) {
                        ...
                        if (_push4) {
                          ...
                          return [
                            data.wholesale_discount > 0 ? (openBlock(), createBlock("div", {
                              ...
                              createVNode("span", { class: "text-[10px] px-1.5 py-0.5 rounded-full bg-red-100 text-red-600 font-semibold w-fit" }, "-" + toDisplayString(Number(data.discount)) + "%", 1)
                  ...
                  createVNode("div", { class: "border border-gray-200 rounded-xl overflow-hidden" }, [
                    ...
                    createVNode("div", { class: "px-3 py-3 space-y-1.5" }, [
                      ...
                      order.value.branch ? (openBlock(), createBlock("p", {
                        ...
                        createVNode("span", { class: "font-medium text-gray-700 ml-1 capitalize" }, toDisplayString(order.value.branch) + " Office", 1)
...
//# sourceMappingURL=OrderDetailDialog-C_KFf1Us.js.map
