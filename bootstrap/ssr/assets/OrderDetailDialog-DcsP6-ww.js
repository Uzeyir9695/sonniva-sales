...
import { ref, mergeProps, withCtx, unref, openBlock, createBlock, createVNode, toDisplayString, createTextVNode, createCommentVNode, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (loading.value) {
              ...
              _push2(`<div class="flex justify-between text-sm text-gray-500"${_scopeId}><span${_scopeId}>მიწოდება</span><span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.delivery_cost)} ₾</span></div><div class="flex justify-between text-sm font-bold text-gray-800 border-t border-gray-200 pt-1.5 mt-1"${_scopeId}><span${_scopeId}>სულ</span><span class="text-brand-600 text-base"${_scopeId}>${ssrInterpolate(order.value.total)} ₾</span></div></div></div><div class="flex justify-end gap-2"${_scopeId}>`);
              ...
              _push2(ssrRenderComponent(_component_Button, {
                ...
                onClick: ($event) => unref(reorder)(order.value.id, selectedItems.value.map((i) => i.id))
              }, null, _parent2, _scopeId));
              _push2(`</div></div>`);
            } else {
              _push2(`<!---->`);
...
const OrderDetailDialog = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: _sfc_main
...
//# sourceMappingURL=OrderDetailDialog-DcsP6-ww.js.map
