...
import { ref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, createCommentVNode, unref, useSSRContext } from "vue";
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          if (data.with_service) {
                            _push4(`<span class="inline-flex items-center gap-1 text-xs font-medium text-brand-600 bg-brand-50 px-1.5 py-0.5 rounded-full w-fit"${_scopeId3}><i class="pi pi-wrench text-xs"${_scopeId3}></i> მონტაჟის სერვისი — ${ssrInterpolate(data.service_price)} ₾ </span>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</div>`);
...
//# sourceMappingURL=OrderDetailDialog-Bws0BU10.js.map
