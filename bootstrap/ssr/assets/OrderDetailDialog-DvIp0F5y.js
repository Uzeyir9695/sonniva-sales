  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Dialog, mergeProps({
        ...
        modal: "",
        header: order.value ? _ctx.$t("orders.orderHash", { no: order.value.invoice_no ?? order.value.id?.slice(0, 8) }) : _ctx.$t("orders.detailTitle"),
          ...
          if (_push2) {
            if (loading.value) {
              ...
              _push2(ssrRenderComponent(_component_Tag, {
                value: orderStatusLabelKey[order.value.status] ? _ctx.$t(orderStatusLabelKey[order.value.status]) : order.value.status,
                severity: statusSeverity[order.value.status]
              }, null, _parent2, _scopeId));
              _push2(`</div><div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4"${_scopeId}><div class="border border-gray-200 rounded-xl overflow-hidden"${_scopeId}><div class="flex items-center gap-2 bg-gray-50 border-b border-gray-200 px-3 py-2"${_scopeId}><i class="pi pi-truck text-brand-500 text-xs"${_scopeId}></i><span class="font-semibold text-gray-700 text-xs uppercase tracking-wide"${_scopeId}>${ssrInterpolate(_ctx.$t("orders.delivery"))}</span></div><div class="px-3 py-3 space-y-1.5"${_scopeId}><p class="font-semibold text-gray-800"${_scopeId}>${ssrInterpolate(deliveryLabelKey[order.value.delivery_type] ? _ctx.$t(deliveryLabelKey[order.value.delivery_type]) : order.value.delivery_type)}</p>`);
              ...
              _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-tag text-xs text-brand-400"${_scopeId}></i> ${ssrInterpolate(_ctx.$t("orders.deliveryLine"))} <span class="font-medium text-gray-700 ml-1"${_scopeId}>${ssrInterpolate(order.value.delivery_cost)} ₾</span></p>`);
              if (order.value.tracking_number) {
                _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-hashtag text-xs text-brand-400"${_scopeId}></i> ${ssrInterpolate(_ctx.$t("orders.trackingLine"))} <span class="font-medium text-gray-700 ml-1"${_scopeId}>${ssrInterpolate(order.value.tracking_number)}</span></p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div>`);
              if (order.value.payment) {
                _push2(`<div class="border border-blue-200 rounded-xl overflow-hidden"${_scopeId}><div class="flex items-center gap-2 bg-blue-50 border-b border-blue-200 px-3 py-2"${_scopeId}><i class="pi pi-credit-card text-blue-500 text-xs"${_scopeId}></i><span class="font-semibold text-blue-700 text-xs uppercase tracking-wide"${_scopeId}>${ssrInterpolate(_ctx.$t("orders.payment"))}</span></div><div class="px-3 py-3 flex flex-wrap gap-5 text-gray-600"${_scopeId}><div${_scopeId}><p class="text-xs text-gray-400 mb-0.5"${_scopeId}>${ssrInterpolate(_ctx.$t("orders.paymentMethod"))}</p><p class="font-semibold text-gray-800"${_scopeId}>${ssrInterpolate(providerText(order.value.payment.provider))}</p></div><div${_scopeId}><p class="text-xs text-gray-400 mb-0.5"${_scopeId}>${ssrInterpolate(_ctx.$t("orders.paymentStatus"))}</p>`);
                _push2(ssrRenderComponent(_component_Tag, {
                  value: paymentStatusLabelKey[order.value.payment.status] ? _ctx.$t(paymentStatusLabelKey[order.value.payment.status]) : order.value.payment.status,
                  severity: order.value.payment.status === "completed" ? "success" : "warn",
                  class: "text-xs"
                }, null, _parent2, _scopeId));
                _push2(`</div>`);
                if (order.value.payment.transaction_id) {
                  _push2(`<div${_scopeId}><p class="text-xs text-gray-400 mb-0.5"${_scopeId}>${ssrInterpolate(_ctx.$t("orders.transactionId"))}</p><code class="text-xs bg-gray-100 px-2 py-0.5 rounded text-gray-700"${_scopeId}>${ssrInterpolate(order.value.payment.transaction_id)}</code></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div></div>`);
              ...
              ssrRenderList(order.value.items, (data) => {
                ...
                if (data.with_service) {
                  _push2(`<span class="inline-flex items-center gap-1 text-xs font-medium text-brand-600 bg-brand-50 px-1.5 py-0.5 rounded-full w-fit"${_scopeId}><i class="pi pi-wrench text-xs"${_scopeId}></i> ${ssrInterpolate(_ctx.$t("orders.setupServiceLine"))} ${ssrInterpolate(data.service_price)} ₾ </span>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<div class="flex items-end justify-between border-t border-gray-100 pt-2 mt-auto"${_scopeId}><div${_scopeId}><p class="text-xs text-gray-400 mb-0.5"${_scopeId}>${ssrInterpolate(_ctx.$t("orders.unitPrice"))}</p>`);
              ...
              if (order.value.wholesale_discount > 0) {
                _push2(`<div class="flex justify-between text-sm text-gray-500"${_scopeId}><span${_scopeId}>${ssrInterpolate(_ctx.$t("orders.subtotal"))}</span><span${_scopeId}><span class="line-through text-gray-400 mr-1"${_scopeId}>${ssrInterpolate((Number(order.value.subtotal) + Number(order.value.wholesale_discount)).toFixed(2))} ₾</span><span class="font-medium text-emerald-600"${_scopeId}>${ssrInterpolate(order.value.subtotal)} ₾</span></span></div>`);
              } else {
                _push2(`<div class="flex justify-between text-sm text-gray-500"${_scopeId}><span${_scopeId}>${ssrInterpolate(_ctx.$t("orders.subtotal"))}</span><span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.subtotal)} ₾</span></div>`);
              }
              if (order.value.wholesale_discount > 0) {
                _push2(`<div class="flex justify-between text-sm text-emerald-600"${_scopeId}><span${_scopeId}>${ssrInterpolate(_ctx.$t("orders.wholesaleDiscount"))}</span><span class="font-medium"${_scopeId}>-${ssrInterpolate(order.value.wholesale_discount)} ₾</span></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<div class="flex justify-between text-sm text-gray-500"${_scopeId}><span${_scopeId}>${ssrInterpolate(_ctx.$t("orders.delivery"))}</span><span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.delivery_cost)} ₾</span></div><div class="flex justify-between text-sm font-bold text-gray-800 border-t border-gray-200 pt-1.5 mt-1"${_scopeId}><span${_scopeId}>${ssrInterpolate(_ctx.$t("common.total"))}</span><span class="text-brand-600 text-base"${_scopeId}>${ssrInterpolate(order.value.total)} ₾</span></div></div></div>`);
              if (order.value.payment?.provider === "invoice" && order.value.payment?.invoice_no) {
                ...
                _push2(ssrRenderComponent(_component_Button, {
                  label: _ctx.$t("orders.downloadInvoice"),
                  icon: "pi pi-download",
                  severity: "secondary",
                  size: "small",
                  outlined: ""
              ...
              loading.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4" }, [
                  createVNode("div", { class: "border border-gray-200 rounded-xl overflow-hidden" }, [
                    createVNode("div", { class: "flex items-center gap-2 bg-gray-50 border-b border-gray-200 px-3 py-2" }, [
                      ...
                      createVNode("span", { class: "font-semibold text-gray-700 text-xs uppercase tracking-wide" }, toDisplayString(_ctx.$t("orders.delivery")), 1)
                    ]),
                    createVNode("div", { class: "px-3 py-3 space-y-1.5" }, [
                      createVNode("p", { class: "font-semibold text-gray-800" }, toDisplayString(deliveryLabelKey[order.value.delivery_type] ? _ctx.$t(deliveryLabelKey[order.value.delivery_type]) : order.value.delivery_type), 1),
                      ...
                      createVNode("p", { class: "flex items-center gap-1.5 text-gray-500" }, [
                        ...
                        createTextVNode(" " + toDisplayString(_ctx.$t("orders.deliveryLine")) + " ", 1),
                      ...
                      order.value.tracking_number ? (openBlock(), createBlock("p", {
                        ...
                        createTextVNode(" " + toDisplayString(_ctx.$t("orders.trackingLine")) + " ", 1),
                  ...
                  order.value.payment ? (openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "flex items-center gap-2 bg-blue-50 border-b border-blue-200 px-3 py-2" }, [
                      ...
                      createVNode("span", { class: "font-semibold text-blue-700 text-xs uppercase tracking-wide" }, toDisplayString(_ctx.$t("orders.payment")), 1)
                    ]),
                    createVNode("div", { class: "px-3 py-3 flex flex-wrap gap-5 text-gray-600" }, [
                      createVNode("div", null, [
                        createVNode("p", { class: "text-xs text-gray-400 mb-0.5" }, toDisplayString(_ctx.$t("orders.paymentMethod")), 1),
                        createVNode("p", { class: "font-semibold text-gray-800" }, toDisplayString(providerText(order.value.payment.provider)), 1)
                      ]),
                      createVNode("div", null, [
                        createVNode("p", { class: "text-xs text-gray-400 mb-0.5" }, toDisplayString(_ctx.$t("orders.paymentStatus")), 1),
                        createVNode(_component_Tag, {
                          value: paymentStatusLabelKey[order.value.payment.status] ? _ctx.$t(paymentStatusLabelKey[order.value.payment.status]) : order.value.payment.status,
                          severity: order.value.payment.status === "completed" ? "success" : "warn",
                          class: "text-xs"
                      ...
                      order.value.payment.transaction_id ? (openBlock(), createBlock("div", { key: 0 }, [
                        createVNode("p", { class: "text-xs text-gray-400 mb-0.5" }, toDisplayString(_ctx.$t("orders.transactionId")), 1),
                ...
                order.value.comment ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "flex items-center gap-2 bg-brand-50 border-b border-brand-200 px-3 py-2" }, [
                    ...
                    createVNode("span", { class: "font-semibold text-brand-700 text-xs uppercase tracking-wide" }, toDisplayString(_ctx.$t("orders.comment")), 1)
                  ]),
                ...
                createVNode("div", { class: "border border-gray-200 rounded-xl overflow-hidden mb-4" }, [
                  createVNode("div", { class: "flex items-center gap-2 bg-gray-50 border-b border-gray-200 px-3 py-2" }, [
                    ...
                    createVNode("span", { class: "font-semibold text-gray-700 text-xs uppercase tracking-wide" }, toDisplayString(_ctx.$t("orders.products")), 1)
                  ]),
                    ...
                    (openBlock(true), createBlock(Fragment, null, renderList(order.value.items, (data) => {
                      return openBlock(), createBlock("div", {
                        ...
                        data.with_service ? (openBlock(), createBlock("span", {
                          ...
                          createTextVNode(" " + toDisplayString(_ctx.$t("orders.setupServiceLine")) + " " + toDisplayString(data.service_price) + " ₾ ", 1)
                        ])) : createCommentVNode("", true),
                        createVNode("div", { class: "flex items-end justify-between border-t border-gray-100 pt-2 mt-auto" }, [
                          createVNode("div", null, [
                            createVNode("p", { class: "text-xs text-gray-400 mb-0.5" }, toDisplayString(_ctx.$t("orders.unitPrice")), 1),
                  ...
                  createVNode("div", { class: "px-4 py-3 border-t border-gray-200 bg-gray-50 space-y-1.5" }, [
                    order.value.wholesale_discount > 0 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("span", null, toDisplayString(_ctx.$t("orders.subtotal")), 1),
                    ...
                    order.value.wholesale_discount > 0 ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("span", null, toDisplayString(_ctx.$t("orders.wholesaleDiscount")), 1),
                    ...
                    createVNode("div", { class: "flex justify-between text-sm text-gray-500" }, [
                      createVNode("span", null, toDisplayString(_ctx.$t("orders.delivery")), 1),
                    ...
                    createVNode("div", { class: "flex justify-between text-sm font-bold text-gray-800 border-t border-gray-200 pt-1.5 mt-1" }, [
                      createVNode("span", null, toDisplayString(_ctx.$t("common.total")), 1),
...
//# sourceMappingURL=OrderDetailDialog-DvIp0F5y.js.map
