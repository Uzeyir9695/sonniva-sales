    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-1ba2e74a${_scopeId}>აუტორიზაცია</title>`);
          } else {
            return [
      ...
      _push(`<div class="w-full max-w-md mx-auto mt-6" data-v-1ba2e74a><div class="bg-white mx-3 rounded-xl shadow-lg transition-shadow duration-500 ease-in-out border border-slate-200 p-8" data-v-1ba2e74a><h1 class="text-2xl font-bold mb-6 text-center" data-v-1ba2e74a>ავტორიზაცია</h1>`);
      ...
      _push(`<form data-v-1ba2e74a><div class="space-y-5" data-v-1ba2e74a>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-envelope" data-v-1ba2e74a${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="email_or_phone" data-v-1ba2e74a${_scopeId2}>ელ.ფოსტა ან ტელეფონი</label>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-lock" data-v-1ba2e74a${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password" class="${ssrRenderClass({ "text-danger": unref(form).errors.password })}" data-v-1ba2e74a${_scopeId2}> პაროლი </label>`);
                } else {
                  return [
      ...
      _push(`<div class="flex items-center justify-between" data-v-1ba2e74a><div class="flex items-center gap-2" data-v-1ba2e74a>`);
      ...
      _push(`<label for="remember" class="text-sm max-sm:text-xs!" data-v-1ba2e74a> დამახსოვრება </label></div>`);
      ...
      _push(`</div></div></form><div class="mt-6" data-v-1ba2e74a>`);
      _push(ssrRenderComponent(unref(script$8), null, null, _parent));
      _push(`<p class="text-center text-sm" data-v-1ba2e74a> არ ხარ რეგისტრირებული? `);
      _push(ssrRenderComponent(unref(Link), {
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1ba2e74a"]]);
export {
  Login as default
};
//# sourceMappingURL=Login-DYtraSQS.js.map
