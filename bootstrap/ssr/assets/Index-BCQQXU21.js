...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6"><h2 class="text-base font-bold text-gray-900 mb-4 flex items-center gap-2"><i class="pi pi-credit-card text-brand-500"></i> გადახდის მეთოდი <i${ssrRenderAttrs(_temp4 = mergeProps({ class: "pi pi-exclamation-circle text-sm text-red-500" }, ssrGetDirectiveProps(_ctx, _directive_tooltip, "სავალდებულო ველი", void 0, { top: true })))}>${"textContent" in _temp4 ? ssrInterpolate(_temp4.textContent) : _temp4.innerHTML ?? ""}</i></h2><div class="grid grid-cols-1 sm:grid-cols-3 gap-3"><!--[-->`);
      ...
      _push(`<!--]--></div><div class="mt-4 flex items-center gap-3"><img src="/payments/payment-cards.jpeg" class="h-6 object-contain rounded" alt="payment cards"><span class="text-xs text-gray-400">Visa, Mastercard</span></div>`);
      ...
      _push(`</div><div class="flex items-start gap-3 px-1">`);
      ...
      _push(`<label for="agreement" class="text-sm text-gray-600 cursor-pointer leading-relaxed"> ვეთანხმები <a${ssrRenderAttr("href", _ctx.route("terms-of-service"))} target="_blank" class="text-brand-500 hover:underline">წესებსა და პირობებს</a><i${ssrRenderAttrs(_temp5 = mergeProps({ class: "pi pi-exclamation-circle text-sm ml-1 text-red-500" }, ssrGetDirectiveProps(_ctx, _directive_tooltip, "სავალდებულო ველი", void 0, { top: true })))}>${"textContent" in _temp5 ? ssrInterpolate(_temp5.textContent) : _temp5.innerHTML ?? ""}</i></label></div></div><div class="lg:col-span-1"><div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sticky top-28"><h2 class="text-base font-bold text-gray-900 mb-5">შეკვეთის შეჯამება</h2><div class="space-y-3 mb-5 h-36 border border-gray-100 rounded-xl p-2 overflow-y-auto"><!--[-->`);
...
//# sourceMappingURL=Index-BCQQXU21.js.map
