  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Swiper), {
        ...
        autoplay: mainSrc.value.length > 1 ? { delay: 3e3, disableOnInteraction: false } : false,
        class: "h-full w-full"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(mainSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-contain"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(mainSrc.value, (src, i) => {
      ...
      _push(ssrRenderComponent(unref(Swiper), {
        ...
        autoplay: doorSrc.value.length > 1 ? { delay: 3e3, disableOnInteraction: false } : false,
        class: "h-full w-full"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(doorSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `door ${i + 1}`)} class="w-full h-full object-contain"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
      ...
      _push(ssrRenderComponent(unref(Swiper), {
        ...
        autoplay: frameSrc.value.length > 1 ? { delay: 3e3, disableOnInteraction: false } : false,
        class: "h-full w-full"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(frameSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `frame ${i + 1}`)} class="w-full h-full object-contain"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
...
//# sourceMappingURL=LargeDeviceMegaMenu-B_x1K-6M.js.map
