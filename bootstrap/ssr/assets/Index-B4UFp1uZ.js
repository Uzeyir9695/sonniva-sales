...
import { _ as _sfc_main$1 } from "./AdminLayout-dG8DBR4Y.js";
...
import "@vueuse/core";
import "./categoryIcons-DJxXDQti.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$1 }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "p-6 max-w-5xl mx-auto space-y-6" }, _attrs))}><h1 class="text-xl font-bold text-gray-800">Manage Home Page</h1><div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-4"><div><p class="font-semibold text-gray-800">Main Banner (large left)</p><p class="text-xs text-gray-400 mt-0.5">Each slide links to an item — search for it, then upload its banner image.</p></div><span class="relative inline-block w-full sm:w-96"><i class="pi pi-search text-gray-400 text-sm absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none"></i>`);
...
//# sourceMappingURL=Index-B4UFp1uZ.js.map
