...
import { ref, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
              ...
              _push2(ssrRenderComponent(_component_DataTable, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_Column, { header: "Weight" }, {
                    ...
                    return [
                      ...
                      createVNode(_component_Column, { header: "Weight" }, {
                        body: withCtx(({ data }) => [
                          createVNode("span", { class: "text-gray-500" }, toDisplayString((data.unit_weight * data.quantity).toFixed(3)) + " kg", 1)
                        ]),
                        _: 1
...
//# sourceMappingURL=OrderDetailDialog-OzL3Z8eK.js.map
