...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$1 }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-4" }, _attrs))} data-v-db9c453f><div class="flex items-center gap-3" data-v-db9c453f>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.payments?.length > 0) {
              _push2(`<div class="rounded-xl border border-gray-200 overflow-hidden" data-v-db9c453f${_scopeId}>`);
              _push2(ssrRenderComponent(_component_DataTable, {
                ...
                header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex flex-wrap items-center justify-between gap-2" data-v-db9c453f${_scopeId2}><h2 class="text-lg font-semibold text-gray-900" data-v-db9c453f${_scopeId2}>${ssrInterpolate(__props.paymentsCount)} Payments</h2>`);
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-mono" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.invoice_no ?? "—")}</span>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div data-v-db9c453f${_scopeId3}><div data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.user_name ?? "—")}</div><div class="text-gray-400" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.user_email)}</div></div>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-mono font-semibold uppercase" data-v-db9c453f${_scopeId3}>${ssrInterpolate(providerLabel[data.provider] ?? data.provider)}</span>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-semibold" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.amount)} ${ssrInterpolate(data.currency)}</span>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-mono text-gray-500 break-all" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.transaction_id ?? "—")}</span>`);
                        } else {
                          return [
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          if (data.delivery_type) {
                            _push4(`<span class="capitalize" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.delivery_type)} (${ssrInterpolate(data.delivery_cost)} ₾)</span>`);
                          } else {
                            _push4(`<span data-v-db9c453f${_scopeId3}>—</span>`);
                          }
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="text-gray-500" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.processed_at ?? "—")}</span>`);
                        } else {
                          return [
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="text-gray-500" data-v-db9c453f${_scopeId3}>${ssrInterpolate(data.created_at)}</span>`);
                        } else {
                          return [
              ...
              _push2(`<div class="flex flex-col items-center justify-center h-64 bg-white rounded-xl border border-gray-200" data-v-db9c453f${_scopeId}><i class="pi pi-credit-card text-6xl text-gray-300 mb-4" data-v-db9c453f${_scopeId}></i><h3 class="text-xl font-semibold text-gray-500" data-v-db9c453f${_scopeId}>No payments found</h3></div>`);
            }
          } else {
            return [
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-db9c453f"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-CXPmFM8d.js.map
