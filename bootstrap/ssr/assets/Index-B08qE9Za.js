...
import { _ as _sfc_main$4 } from "./SwiperCarousel-B3d4HcpH.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (mainSrc.value.length) {
        ...
        if (mounted.value) {
                ...
                ssrRenderList(mainSrc.value, (slide, i) => {
                  _push2(ssrRenderComponent(unref(SwiperSlide), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(slide.item_slug ? unref(Link) : "div"), {
                          href: slide.item_slug ? _ctx.route("items.show", slide.item_slug) : void 0,
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              _push4(`<img${ssrRenderAttr("src", slide.image_url)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-fill"${_scopeId3}></picture>`);
                            } else {
                              return [
                        ...
                        return [
                          (openBlock(), createBlock(resolveDynamicComponent(slide.item_slug ? unref(Link) : "div"), {
                            href: slide.item_slug ? _ctx.route("items.show", slide.item_slug) : void 0,
                            class: "block h-full w-full"
                          }, {
                            default: withCtx(() => [
          ...
          _push(`<img${ssrRenderAttr("src", mainSrc.value[0].image_url)} alt="main" class="w-full h-full object-fill"></picture>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
...
//# sourceMappingURL=Index-B08qE9Za.js.map
