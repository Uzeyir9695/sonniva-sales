...
import { R as Ripple, s as script$6, a as script$a } from "./index-YvTnrAwi.js";
import { mergeProps, resolveDirective, openBlock, createElementBlock, createElementVNode, withDirectives, createBlock, resolveDynamicComponent, normalizeClass, createCommentVNode, toDisplayString, resolveComponent, withCtx, createVNode, Transition, renderSlot, Fragment, renderList, createTextVNode, ref, computed, unref, useSSRContext } from "vue";
import { s as script$d } from "./index-D0sux6YN.js";
import { s as script$b, a as script$c } from "./index-BVLrsogj.js";
import { s as script$7, a as script$8, b as script$9 } from "./index-fvkEaty1.js";
import { s as script$5 } from "./index-BzRznsIW.js";
import { s as script$4 } from "./index-D46B4f3g.js";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrGetDirectiveProps, ssrRenderAttr } from "vue/server-renderer";
import { _ as _sfc_main$1 } from "./AdminLayout-Bb0hl7GE.js";
import { _ as _sfc_main$4 } from "./TableSkeleton-jtC7qFHK.js";
import _sfc_main$3 from "./OrderDetailDialog-Bm_Z5Op1.js";
import { useMediaQuery, useDebounceFn } from "@vueuse/core";
import { usePoll, usePage, router, Deferred } from "@inertiajs/vue3";
...
import "./index-DWe94jOp.js";
import "@primeuix/styles/paginator";
import "@primevue/icons/angledoubleleft";
import "./index-B9TXFrYE.js";
  ...
  setup(__props) {
    ...
    function submitDispatch() {
      ...
      router.put(route("admin.orders.dispatch", selectedDispatchOrder.value.id), {
        ...
        preserveScroll: true,
        onSuccess: () => toast.add({ severity: "success", summary: "Updated", detail: "Order marked as dispatched.", life: 3e3 }),
        onError: () => toast.add({ severity: "error", summary: "Error", detail: "Failed to update status.", life: 3e3 })
      });
    }
      ...
      confirm.require({
        ...
        accept: () => {
          router.put(route("admin.orders.deliver", order.id), {}, {
            preserveScroll: true,
            onSuccess: () => toast.add({ severity: "success", summary: "Updated", detail: "Order marked as delivered.", life: 3e3 }),
            onError: () => toast.add({ severity: "error", summary: "Error", detail: "Failed to update status.", life: 3e3 })
          });
        }
      });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col gap-3 py-2" data-v-45121203${_scopeId}><div class="flex items-center gap-2" data-v-45121203${_scopeId}>`);
            ...
            _push2(`<label for="sendToEmail" data-v-45121203${_scopeId}>Send to company email</label></div><div class="flex items-center gap-2" data-v-45121203${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Checkbox, {
            ...
            _push2(`<label for="sendToBC" data-v-45121203${_scopeId}>Send to Business Central</label></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        visible: dispatchVisible.value,
        "onUpdate:visible": ($event) => dispatchVisible.value = $event,
        header: "Mark as Dispatched",
        modal: "",
        style: { width: "24rem" }
      }, {
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, {
              ...
              severity: "secondary",
              variant: "text",
              onClick: ($event) => dispatchVisible.value = false
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_Button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col gap-3 py-2" data-v-45121203${_scopeId}><p class="text-sm text-gray-600" data-v-45121203${_scopeId}> Mark order ${ssrInterpolate(selectedDispatchOrder.value?.invoice_no ?? selectedDispatchOrder.value?.id?.slice(0, 8))} as dispatched? </p><div class="flex flex-col gap-1.5" data-v-45121203${_scopeId}><label for="trackingNumber" class="text-xs font-medium text-gray-500" data-v-45121203${_scopeId}>Tracking number (optional)</label>`);
            _push2(ssrRenderComponent(_sfc_main$2, {
              id: "trackingNumber",
              modelValue: dispatchTrackingNumber.value,
              "onUpdate:modelValue": ($event) => dispatchTrackingNumber.value = $event,
              placeholder: "e.g. ON123456789"
            }, null, _parent2, _scopeId));
            _push2(`</div></div>`);
          } else {
            return [
              createVNode("div", { class: "flex flex-col gap-3 py-2" }, [
                createVNode("p", { class: "text-sm text-gray-600" }, " Mark order " + toDisplayString(selectedDispatchOrder.value?.invoice_no ?? selectedDispatchOrder.value?.id?.slice(0, 8)) + " as dispatched? ", 1),
      ...
      _push(`<div class="rounded-xl overflow-hidden" data-v-45121203>`);
                  ...
                  ssrRenderList(tabs, (tab) => {
                    _push3(ssrRenderComponent(_component_Tab, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<i class="${ssrRenderClass(["pi text-sm", tab.icon])}" data-v-45121203${_scopeId3}></i><span data-v-45121203${_scopeId3}>${ssrInterpolate(tab.label)}</span>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_DataTable, {
              ...
              lazy: "",
              paginator: "",
              rows: __props.orders?.per_page ?? 20,
              totalRecords: __props.orders?.total ?? 0,
              first: ((__props.orders?.current_page ?? 1) - 1) * (__props.orders?.per_page ?? 20),
              onPage,
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-2" data-v-45121203${_scopeId2}><i class="pi pi-shopping-cart text-gray-500" data-v-45121203${_scopeId2}></i><span class="font-semibold text-gray-700" data-v-45121203${_scopeId2}>${ssrInterpolate(__props.orders.total)} order${ssrInterpolate(__props.orders.total !== 1 ? "s" : "")} <span class="capitalize text-gray-400" data-v-45121203${_scopeId2}>(${ssrInterpolate(__props.status)})</span></span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center gap-2" }, [
                      createVNode("i", { class: "pi pi-shopping-cart text-gray-500" }),
                      createVNode("span", { class: "font-semibold text-gray-700" }, [
                        createTextVNode(toDisplayString(__props.orders.total) + " order" + toDisplayString(__props.orders.total !== 1 ? "s" : "") + " ", 1),
              ...
              empty: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col items-center justify-center h-40" data-v-45121203${_scopeId2}><i class="pi pi-inbox text-5xl text-gray-300 mb-3" data-v-45121203${_scopeId2}></i><p class="text-gray-500" data-v-45121203${_scopeId2}>No orders found.</p></div>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (__props.status === "dispatched" || __props.status === "delivered") {
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-mono text-xs" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.tracking_number ?? "—")}</span>`);
                        } else {
                          return [
                            createVNode("span", { class: "font-mono text-xs" }, toDisplayString(data2.tracking_number ?? "—"), 1)
                          ];
                        }
                      }),
                      _: 1
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    field: "invoice_no",
                    header: "Order №",
                    frozen: !unref(isMobile),
                    style: { "min-width": "12rem" }
                  }, {
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="font-mono text-xs" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.invoice_no ?? "—")}</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="font-mono text-xs text-gray-600" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.user?.tax_id ?? "—")}</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-45121203${_scopeId3}><p class="font-medium" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.user?.name ?? "—")}</p><p class="text-xs text-gray-400" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.user?.phone)}</p></div>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data2.discount_total > 0) {
                          _push4(`<div class="flex flex-col gap-0.5" data-v-45121203${_scopeId3}><span class="line-through text-gray-400 text-xs" data-v-45121203${_scopeId3}>${ssrInterpolate((Number(data2.total) + Number(data2.discount_total)).toFixed(2))} ₾</span><span class="font-semibold" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.total)} ₾</span><span class="text-red-600 text-xs font-medium" data-v-45121203${_scopeId3}>-${ssrInterpolate(Number(data2.discount_total).toFixed(2))} ₾</span></div>`);
                        } else {
                          _push4(`<span class="font-semibold" data-v-45121203${_scopeId3}>${ssrInterpolate(data2.total)} ₾</span>`);
                        }
                      } else {
                        return [
                          data2.discount_total > 0 ? (openBlock(), createBlock("div", {
                            key: 0,
                            class: "flex flex-col gap-0.5"
                          }, [
                            createVNode("span", { class: "line-through text-gray-400 text-xs" }, toDisplayString((Number(data2.total) + Number(data2.discount_total)).toFixed(2)) + " ₾", 1),
                            createVNode("span", { class: "font-semibold" }, toDisplayString(data2.total) + " ₾", 1),
                            createVNode("span", { class: "text-red-600 text-xs font-medium" }, "-" + toDisplayString(Number(data2.discount_total).toFixed(2)) + " ₾", 1)
                          ])) : (openBlock(), createBlock("span", {
                            key: 1,
                            class: "font-semibold"
                          }, toDisplayString(data2.total) + " ₾", 1))
                        ];
                      }
                    }),
                    footer: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex flex-col gap-0.5" data-v-45121203${_scopeId3}><span class="line-through text-gray-400 text-xs" data-v-45121203${_scopeId3}>${ssrInterpolate(totalsSummary.value.before.toFixed(2))} ₾</span><span class="font-semibold text-gray-800" data-v-45121203${_scopeId3}>${ssrInterpolate(totalsSummary.value.after.toFixed(2))} ₾</span>`);
                        if (totalsSummary.value.discount > 0) {
                          _push4(`<span class="text-red-600 text-xs font-medium" data-v-45121203${_scopeId3}>-${ssrInterpolate(totalsSummary.value.discount.toFixed(2))} ₾</span>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(`</div>`);
                        ...
                        return [
                          createVNode("div", { class: "flex flex-col gap-0.5" }, [
                            createVNode("span", { class: "line-through text-gray-400 text-xs" }, toDisplayString(totalsSummary.value.before.toFixed(2)) + " ₾", 1),
                            createVNode("span", { class: "font-semibold text-gray-800" }, toDisplayString(totalsSummary.value.after.toFixed(2)) + " ₾", 1),
                            totalsSummary.value.discount > 0 ? (openBlock(), createBlock("span", {
                              key: 0,
                              class: "text-red-600 text-xs font-medium"
                            }, "-" + toDisplayString(totalsSummary.value.discount.toFixed(2)) + " ₾", 1)) : createCommentVNode("", true)
                          ])
                        ];
                      }
                    }),
                  ...
                  _push3(ssrRenderComponent(_component_Column, { header: "Payment" }, {
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data2.payment) {
                          _push4(`<span class="uppercase text-xs font-semibold text-gray-500" data-v-45121203${_scopeId3}>${ssrInterpolate(providerLabel[data2.payment.provider] ?? data2.payment.provider)}</span>`);
                        } else {
                          _push4(`<span class="text-gray-300" data-v-45121203${_scopeId3}>—</span>`);
                        }
                      } else {
                        return [
                      ...
                      filter: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_DatePicker, {
                            ...
                            "onUpdate:modelValue": [($event) => approvedAtDates.value = $event, filterByApprovedAtDelivered],
                            showIcon: "",
                            showButtonBar: "",
                            onClearClick: resetApprovedAtDelivered,
                  ...
                  if (__props.status === "delivered") {
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate(data2.delivered_at ?? "—")}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(data2.delivered_at ?? "—"), 1)
                          ];
                        }
                      }),
                      filter: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(_component_DatePicker, {
                            modelValue: deliveredAtDates.value,
                            "onUpdate:modelValue": [($event) => deliveredAtDates.value = $event, filterByDeliveredAt],
                            showIcon: "",
                            showButtonBar: "",
                            onClearClick: resetDeliveredAt,
                            placeholder: "DD/MM/YY",
                            selectionMode: "range",
                            hideOnRangeSelection: "",
                            size: "small",
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center gap-1" data-v-45121203${_scopeId3}>`);
                        ...
                        if (data2.status !== "cancelled") {
                          _push4(`<a${ssrRenderAttr("href", _ctx.route("download.file", data2.invoice_no))} target="_blank" data-v-45121203${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Button, mergeProps({
                            icon: "pi pi-file-pdf",
                            size: "small",
                            variant: "text",
                            ...
                            rounded: "",
                            severity: "secondary"
                          }, ssrGetDirectiveProps(_ctx, _directive_tooltip, "Download PDF", void 0, { top: true })), null, _parent4, _scopeId3));
                          _push4(`</a>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        ...
                        if (data2.status === "paid" || data2.status === "limit") {
                          _push4(ssrRenderComponent(_component_Button, mergeProps({
                            ...
                            rounded: "",
                            severity: "success",
                            onClick: ($event) => openDispatchDialog(data2)
                          }, ssrGetDirectiveProps(_ctx, _directive_tooltip, "Mark as Dispatched", void 0, { top: true })), null, _parent4, _scopeId3));
                        } else {
                          _push4(`<!---->`);
                        }
                        if (data2.status === "dispatched") {
                          _push4(ssrRenderComponent(_component_Button, mergeProps({
                            icon: "pi pi-verified",
                            size: "small",
                            variant: "text",
                            ...
                            rounded: "",
                            severity: "success",
                            onClick: ($event) => confirmMarkDelivered(data2)
                          }, ssrGetDirectiveProps(_ctx, _directive_tooltip, "Mark as Delivered", void 0, { top: true })), null, _parent4, _scopeId3));
                        } else {
                          _push4(`<!---->`);
                        }
                        if (data2.status === "pending") {
                        ...
                        return [
                          createVNode("div", { class: "flex items-center gap-1" }, [
                            ...
                            data2.status !== "cancelled" ? (openBlock(), createBlock("a", {
                              key: 0,
                              href: _ctx.route("download.file", data2.invoice_no),
                              target: "_blank"
                            }, [
                              withDirectives(createVNode(_component_Button, {
                                icon: "pi pi-file-pdf",
                            ...
                            data2.status === "dispatched" ? withDirectives((openBlock(), createBlock(_component_Button, {
                              key: 3,
                              icon: "pi pi-verified",
                              size: "small",
                              variant: "text",
                  ...
                  return [
                    ...
                    __props.status === "dispatched" || __props.status === "delivered" ? (openBlock(), createBlock(_component_Column, {
                      key: 0,
                      field: "tracking_number",
                      header: "Tracking #"
                    }, {
                    ...
                    __props.status === "delivered" ? (openBlock(), createBlock(_component_Column, {
                      key: 2,
                      header: "Paid At",
                      style: { "min-width": "14rem" }
                    }, {
            ...
            return [
              createVNode(_component_DataTable, {
                ...
                _: 1
              }, 8, ["value", "rows", "totalRecords", "first", "onFilter", "filters", "onUpdate:filters"])
            ];
          }
        }),
        _: 1
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-45121203"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-CRiuVK9v.js.map
