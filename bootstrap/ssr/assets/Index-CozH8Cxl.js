                  ...
                  _push3(ssrRenderComponent(_component_TabPanel, { value: "0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<hr class="my-6 border-gray-100"${_scopeId3}><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Missing Item Images</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Fetches images from Business Central for in-stock items (inventory &gt; 0) that don&#39;t have any yet. Runs in the background. </p>`);
                        _push4(ssrRenderComponent(_component_Button, {
...
//# sourceMappingURL=Index-CozH8Cxl.js.map
