    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col gap-3 py-2" data-v-4fa23f5f${_scopeId}><div class="flex items-center gap-2" data-v-4fa23f5f${_scopeId}>`);
            ...
            _push2(`<label for="sendToEmail" data-v-4fa23f5f${_scopeId}>Send to company email</label></div><div class="flex items-center gap-2" data-v-4fa23f5f${_scopeId}>`);
            _push2(ssrRenderComponent(_component_Checkbox, {
            ...
            _push2(`<label for="sendToBC" data-v-4fa23f5f${_scopeId}>Send to Business Central</label></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col gap-3 py-2" data-v-4fa23f5f${_scopeId}><p class="text-sm text-gray-600" data-v-4fa23f5f${_scopeId}> Mark order ${ssrInterpolate(selectedDispatchOrder.value?.invoice_no ?? selectedDispatchOrder.value?.id?.slice(0, 8))} as dispatched? </p><div class="flex flex-col gap-1.5" data-v-4fa23f5f${_scopeId}><label for="trackingNumber" class="text-xs font-medium text-gray-500" data-v-4fa23f5f${_scopeId}>Tracking number (optional)</label>`);
      ...
      _push(`<div class="rounded-xl overflow-hidden" data-v-4fa23f5f>`);
                  ...
                  ssrRenderList(tabs, (tab) => {
                    _push3(ssrRenderComponent(_component_Tab, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<i class="${ssrRenderClass(["pi text-sm", tab.icon])}" data-v-4fa23f5f${_scopeId3}></i><span data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(tab.label)}</span>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_DataTable, {
              ...
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center gap-2" data-v-4fa23f5f${_scopeId2}><i class="pi pi-shopping-cart text-gray-500" data-v-4fa23f5f${_scopeId2}></i><span class="font-semibold text-gray-700" data-v-4fa23f5f${_scopeId2}>${ssrInterpolate(__props.orders.data.length)} order${ssrInterpolate(__props.orders.data.length !== 1 ? "s" : "")} <span class="capitalize text-gray-400" data-v-4fa23f5f${_scopeId2}>(${ssrInterpolate(__props.status)})</span></span></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center gap-2" }, [
              ...
              empty: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col items-center justify-center h-40" data-v-4fa23f5f${_scopeId2}><i class="pi pi-inbox text-5xl text-gray-300 mb-3" data-v-4fa23f5f${_scopeId2}></i><p class="text-gray-500" data-v-4fa23f5f${_scopeId2}>No orders found.</p></div>`);
                } else {
                  return [
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (__props.status === "dispatched" || __props.status === "delivered") {
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="font-mono text-xs" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(data2.tracking_number ?? "—")}</span>`);
                        } else {
                          return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="font-mono text-xs" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(data2.invoice_no ?? "—")}</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="font-mono text-xs text-gray-600" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(data2.user?.tax_id ?? "—")}</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div data-v-4fa23f5f${_scopeId3}><p class="font-medium" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(data2.user?.name ?? "—")}</p><p class="text-xs text-gray-400" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(data2.user?.phone)}</p></div>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<span class="font-semibold" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(data2.total)} ₾</span>`);
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, { header: "Payment" }, {
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (data2.payment) {
                          _push4(`<span class="uppercase text-xs font-semibold text-gray-500" data-v-4fa23f5f${_scopeId3}>${ssrInterpolate(providerLabel[data2.payment.provider] ?? data2.payment.provider)}</span>`);
                        } else {
                          _push4(`<span class="text-gray-300" data-v-4fa23f5f${_scopeId3}>—</span>`);
                        }
                      } else {
                        return [
                  ...
                  _push3(ssrRenderComponent(_component_Column, {
                    ...
                    body: withCtx(({ data: data2 }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="flex items-center gap-1" data-v-4fa23f5f${_scopeId3}>`);
                        ...
                        if (data2.status !== "cancelled") {
                          _push4(`<a${ssrRenderAttr("href", _ctx.route("download.file", data2.invoice_no))} target="_blank" data-v-4fa23f5f${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Button, mergeProps({
                            icon: "pi pi-file-pdf",
                            size: "small",
                            variant: "text",
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4fa23f5f"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-c3X9h7YW.js.map
