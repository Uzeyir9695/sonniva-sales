...
import { R as Ripple, s as script$2 } from "./index-YvTnrAwi.js";
...
import { resolveComponent, resolveDirective, openBlock, createElementBlock, Fragment, createElementVNode, mergeProps, renderSlot, createVNode, withCtx, createBlock, resolveDynamicComponent, renderList, withDirectives, createSlots, normalizeClass, createCommentVNode, ref, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    const whatsappGroupLink = "https://wa.me/995596720001";
    const companyPhone = "+995555371651";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SpeedDial = script;
      ...
      _push(ssrRenderComponent(_component_SpeedDial, {
        model: items.value,
        direction: "up",
        class: "fixed right-[2.5rem] lg:right-[2.5rem] bottom-[5.5rem] lg:bottom-[6rem] z-10",
        tooltipOptions: { position: "left" }
      }, {
        button: withCtx(({ toggleCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, {
              class: "bg-brand-500 border-none hover:-rotate-10",
              rounded: "",
              icon: "pi pi-phone",
        ...
        item: withCtx(({ item, toggleCallback }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            }, ssrGetDirectiveProps(_ctx, _directive_tooltip, item.label, void 0, { top: true })), null, _parent2, _scopeId));
          } else {
            return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Contact/ContactButtons.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
export {
  _sfc_main as default
};
//# sourceMappingURL=ContactButtons-brRYjB8X.js.map
