...
import { ref, onMounted, computed, watch, unref, withCtx, createVNode, openBlock, createBlock, createCommentVNode, mergeProps, createTextVNode, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="h-px bg-gray-200 mb-8"></div>`);
      ...
      _push(ssrRenderComponent(_component_Panel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ul class="space-y-2 text-xs text-gray-600"${_scopeId}><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <span${_scopeId}><strong${_scopeId}>თვითგატანა ოფისიდან:</strong> უფასო. გატანის წერტილები <a href="#" class="text-blue-500 hover:underline"${_scopeId}>რუკაზე</a></span></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <span${_scopeId}>მიწოდება თბილისში: 1000+ ₾ უფასო, 1000-მდე ₾ 70 </span></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <span${_scopeId}>მიწოდება რეგიონებში: 200 ლარიდან</span></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <a href="#" class="text-blue-500 hover:underline"${_scopeId}>დეტალურად მიწოდების შესახებ</a></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <span${_scopeId}>13:00-მდე გაფორმებულ შეკვეთებს გაწვდით იმავე დღეს!</span></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <span${_scopeId}>მიტანის სერვისის ფარგლებში პროდუქციის მანქანიდან ჩამოტვირთვა და სართულზე ატანა არ შედის მომსახურებაში.</span></li></ul>`);
          } else {
            return [
              createVNode("ul", { class: "space-y-2 text-xs text-gray-600" }, [
                createVNode("li", { class: "flex gap-2" }, [
                  ...
                  createVNode("span", null, [
                    ...
                    createTextVNode(" უფასო. გატანის წერტილები "),
                    createVNode("a", {
                      href: "#",
                ...
                createVNode("li", { class: "flex gap-2" }, [
                  createVNode("span", { class: "text-brand-500" }, "→"),
                  createTextVNode(),
                  createVNode("span", null, "მიწოდება თბილისში: 1000+ ₾ უფასო, 1000-მდე ₾ 70 ")
                ]),
                createVNode("li", { class: "flex gap-2" }, [
                  createVNode("span", { class: "text-brand-500" }, "→"),
                  createTextVNode(),
                  createVNode("span", null, "მიწოდება რეგიონებში: 200 ლარიდან")
                ]),
                createVNode("li", { class: "flex gap-2" }, [
                  createVNode("span", { class: "text-brand-500" }, "→"),
                  createTextVNode(),
                  createVNode("a", {
                    href: "#",
                    class: "text-blue-500 hover:underline"
                  }, "დეტალურად მიწოდების შესახებ")
                ]),
                createVNode("li", { class: "flex gap-2" }, [
                  createVNode("span", { class: "text-brand-500" }, "→"),
                  createTextVNode(),
                  createVNode("span", null, "13:00-მდე გაფორმებულ შეკვეთებს გაწვდით იმავე დღეს!")
                ]),
                createVNode("li", { class: "flex gap-2" }, [
                  createVNode("span", { class: "text-brand-500" }, "→"),
                  createTextVNode(),
...
//# sourceMappingURL=Show-7Hw_aoZp.js.map
