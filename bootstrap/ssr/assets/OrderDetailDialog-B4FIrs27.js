        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (loading.value) {
              ...
              _push2(`<div class="flex items-center justify-end gap-6 px-4 py-3 border-t border-gray-200 bg-gray-50"${_scopeId}><span class="text-gray-500"${_scopeId}>ჯამი: <span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.subtotal)} ₾</span></span><span class="text-gray-800 font-bold"${_scopeId}> სულ: <span class="text-brand-600 text-base"${_scopeId}>${ssrInterpolate(order.value.total)} ₾</span></span></div></div>`);
            ...
            return [
              loading.value ? (openBlock(), createBlock("div", {
                ...
                order.value.payment?.invoice_no ? (openBlock(), createBlock("div", {
                  key: 1,
...
//# sourceMappingURL=OrderDetailDialog-B4FIrs27.js.map
