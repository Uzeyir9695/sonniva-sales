...
import { s as script$8 } from "./index-hSjFFc9a.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-d96181df${_scopeId}>რეგისტრაცია</title>`);
          } else {
            return [
      ...
      _push(`<div class="w-full max-w-md mx-auto my-6" data-v-d96181df><div class="bg-white mx-3 rounded-xl shadow-lg transition-shadow duration-500 ease-in-out border transiton-all border-gray-200 p-8" data-v-d96181df><h1 class="text-2xl font-bold text-gray-800 text-center" data-v-d96181df>რეგისტრაცია</h1><div class="flex justify-center my-4" data-v-d96181df>`);
      _push(ssrRenderComponent(_component_SelectButton, {
        ...
        option: withCtx((slotProps, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-d96181df${_scopeId}>${ssrInterpolate(slotProps.option.value)}</p>`);
          } else {
            return [
      ...
      if (Object.keys(__props.errors).length > 0) {
        _push(`<div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex" data-v-d96181df><i class="pi pi-exclamation-circle text-red-400 mr-3 mt-0.5" data-v-d96181df></i><div class="text-red-600 text-sm" data-v-d96181df><!--[-->`);
        ssrRenderList(__props.errors, (error, key) => {
          _push(`<p data-v-d96181df>${ssrInterpolate(error)}</p>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form class="flex flex-col gap-6" data-v-d96181df>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-user text-gray-400" data-v-d96181df${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="name" data-v-d96181df${_scopeId2}>${ssrInterpolate(selectedUserType.value?.key === "individual" ? "სახელი" : "კომპანიის სახელი")}</label>`);
                } else {
                  return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<i class="pi pi-users text-gray-400" data-v-d96181df${_scopeId2}></i>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<label for="lastname" data-v-d96181df${_scopeId2}> გვარი </label>`);
                  } else {
                    return [
                      createVNode(_component_InputText, {
                        id: "lastname",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-mobile text-gray-400" data-v-d96181df${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="phone" data-v-d96181df${_scopeId2}> ტელეფონი </label>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-id-card text-gray-400" data-v-d96181df${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="id-number" data-v-d96181df${_scopeId2}>${ssrInterpolate(selectedUserType.value?.key === "individual" ? "პირადი ნომერი" : "საიდენტიფიკაციო ნომერი")}</label>`);
                } else {
                  return [
                    withDirectives(createVNode(_component_InputText, {
                      id: "id-number",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-envelope text-gray-400" data-v-d96181df${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="email" data-v-d96181df${_scopeId2}>ელ. ფოსტა</label>`);
                } else {
                  return [
                    createVNode(_component_InputText, {
                      id: "email",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-lock text-gray-400" data-v-d96181df${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password" data-v-d96181df${_scopeId2}> პაროლი </label>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password_confirm" data-v-d96181df${_scopeId2}> გაიმეორე პაროლი </label>`);
                } else {
                  return [
                    createVNode(_component_Password, {
                      modelValue: unref(form).password_confirmation,
      ...
      _push(`<p data-v-d96181df> თუ გაქვთ მცირე მეწარმის სტატუსი ან ხართ იურიდიული პირი, სპეციალური შეთავაზებების მისაღებად დაგვიკავშირდით </p><div data-v-d96181df>`);
      ...
      _push(`<div data-v-d96181df><div class="flex justify-center gap-x-2 text-sm" data-v-d96181df><p class="w-fit" data-v-d96181df>უკვე ხარ რეგისტრირებული?</p><div class="flex items-center w-fit gap-x-2 text-nowrap" data-v-d96181df>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="pi pi-user text-brand-500" data-v-d96181df${_scopeId}></i> შესვლა `);
          } else {
            return [
...
const Register = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d96181df"]]);
export {
  Register as default
};
//# sourceMappingURL=Register-Bz1aV81p.js.map
