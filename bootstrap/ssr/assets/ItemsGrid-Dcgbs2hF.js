...
import { _ as _sfc_main$3 } from "./Paginate-__KahpUV.js";
import { a as _sfc_main$4 } from "./QuickViewDialog-DXL2MTuj.js";
import { _ as _sfc_main$2 } from "./ItemCard-DWU1Z1SG.js";
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.items.data?.length > 0) {
        ...
        _push(`<div class="flex flex-col items-center justify-center h-72 text-center"><div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mb-4"><i class="pi pi-th-large text-3xl text-gray-300"></i></div><h3 class="text-lg font-medium text-gray-500">${ssrInterpolate(_ctx.$t("item.noProducts"))}</h3></div>`);
      }
...
//# sourceMappingURL=ItemsGrid-Dcgbs2hF.js.map
