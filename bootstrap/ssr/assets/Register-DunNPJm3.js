...
import { R as Ripple, s as script$9 } from "./index-YvTnrAwi.js";
import { s as script$8 } from "./index-o6MKZAXO.js";
import { s as script$7 } from "./index-BAgOeBfa.js";
import { s as script$6 } from "./index-1kO8dZCM.js";
import { s as script$4, a as script$5, b as script$a } from "./index-CFQqRDLI.js";
...
import { resolveDirective, withDirectives, openBlock, createElementBlock, mergeProps, createElementVNode, renderSlot, normalizeClass, createCommentVNode, toDisplayString, resolveComponent, Fragment, renderList, createBlock, createSlots, withCtx, computed, ref, unref, createVNode, createTextVNode, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_InputGroup = script$4;
      const _component_InputGroupAddon = script$5;
      const _component_FloatLabel = script$6;
      const _component_InputText = script$7;
      const _component_Password = script$8;
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-38e2c97f${_scopeId}>${ssrInterpolate(_ctx.$t("auth.registerTitle"))}</title>`);
          } else {
            return [
      ...
      _push(`<div class="w-full max-w-md mx-auto my-6" data-v-38e2c97f><div class="bg-white mx-3 rounded-xl shadow-lg transition-shadow duration-500 ease-in-out border transiton-all border-gray-200 p-8" data-v-38e2c97f><h1 class="text-2xl font-bold text-gray-800 text-center" data-v-38e2c97f>${ssrInterpolate(_ctx.$t("auth.registerHeading"))}</h1><div class="flex justify-center my-4" data-v-38e2c97f>`);
      _push(ssrRenderComponent(_component_SelectButton, {
        ...
        option: withCtx((slotProps, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-38e2c97f${_scopeId}>${ssrInterpolate(slotProps.option.value)}</p>`);
          } else {
            return [
      ...
      if (Object.keys(__props.errors).length > 0) {
        _push(`<div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex" data-v-38e2c97f><i class="pi pi-exclamation-circle text-red-400 mr-3 mt-0.5" data-v-38e2c97f></i><div class="text-red-600 text-sm" data-v-38e2c97f><!--[-->`);
        ssrRenderList(__props.errors, (error, key) => {
          _push(`<p data-v-38e2c97f>${ssrInterpolate(error)}</p>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<form class="flex flex-col gap-6" data-v-38e2c97f><div class="flex flex-col gap-2" data-v-38e2c97f><p class="text-sm" data-v-38e2c97f>${ssrInterpolate(_ctx.$t("auth.notGeorgianCitizen"))}</p><div class="flex items-center gap-2" data-v-38e2c97f>`);
      ...
      _push(`<label for="is_foreign_resident" class="text-sm" data-v-38e2c97f>${ssrInterpolate(_ctx.$t("auth.nonResident"))}</label></div></div>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-user text-gray-400" data-v-38e2c97f${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="name" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(selectedUserType.value?.key === "individual" ? _ctx.$t("auth.firstName") : _ctx.$t("auth.companyName"))}</label>`);
                } else {
                  return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<i class="pi pi-users text-gray-400" data-v-38e2c97f${_scopeId2}></i>`);
                  } else {
                    return [
              ...
              _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<label for="lastname" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.lastName"))}</label>`);
                  } else {
                    return [
                      createVNode(_component_InputText, {
                        id: "lastname",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-mobile text-gray-400" data-v-38e2c97f${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="phone" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.phone"))}</label>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-id-card text-gray-400" data-v-38e2c97f${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="id-number" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(selectedUserType.value?.key === "individual" ? _ctx.$t("auth.personalId") : _ctx.$t("auth.identificationNumber"))}</label>`);
                } else {
                  return [
                    withDirectives(createVNode(_component_InputText, {
                      id: "id-number",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-envelope text-gray-400" data-v-38e2c97f${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="email" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.email"))}</label>`);
                } else {
                  return [
                    createVNode(_component_InputText, {
                      id: "email",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-lock text-gray-400" data-v-38e2c97f${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.password"))}</label>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password_confirm" data-v-38e2c97f${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.repeatPassword"))}</label>`);
                } else {
                  return [
                    createVNode(_component_Password, {
                      modelValue: unref(form).password_confirmation,
      ...
      _push(`<p data-v-38e2c97f>${ssrInterpolate(_ctx.$t("auth.entrepreneurNote"))}</p><div data-v-38e2c97f>`);
      ...
      _push(`</div>`);
      _push(ssrRenderComponent(unref(script$a), { "pt:root:class": "m-0" }, null, _parent));
      _push(`<div data-v-38e2c97f><div class="flex justify-center gap-x-2 text-sm" data-v-38e2c97f><p class="w-fit" data-v-38e2c97f>${ssrInterpolate(_ctx.$t("auth.alreadyRegistered"))}</p><div class="flex items-center w-fit gap-x-2 text-nowrap" data-v-38e2c97f>`);
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="pi pi-user text-brand-500" data-v-38e2c97f${_scopeId}></i> ${ssrInterpolate(_ctx.$t("auth.signIn"))}`);
          } else {
            return [
...
const Register = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-38e2c97f"]]);
export {
  Register as default
};
//# sourceMappingURL=Register-DunNPJm3.js.map
