import { ref, onMounted, computed, mergeProps, unref, withCtx, createVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext, toDisplayString, createTextVNode } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderVNode, ssrRenderAttr, ssrInterpolate, ssrRenderTeleport, ssrRenderClass, ssrGetDirectiveProps } from "vue/server-renderer";
...
import { _ as _sfc_main$4 } from "./SwiperCarousel-Dzdc2uyy.js";
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-cols-1 grid-rows-[minmax(0,1.4fr)_minmax(0,1fr)] gap-3 px-4 h-[calc(100vh-100px)] max-sm:flex max-sm:flex-col max-sm:h-auto" }, _attrs))}>`);
      if (mainSrc.value.length) {
        _push(`<div class="relative w-full min-w-0 rounded-xl overflow-hidden min-h-0 max-sm:h-60">`);
        if (mounted.value) {
                ...
                ssrRenderList(mainSrc.value, (slide, i) => {
                  _push2(ssrRenderComponent(unref(SwiperSlide), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(slideHref(slide) ? unref(Link) : "div"), {
                          href: slideHref(slide),
                          class: "block h-full w-full"
                        }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<picture class="block h-full w-full ring"${_scopeId3}>`);
                              if (slide.mobile_image_url) {
                                _push4(`<source${ssrRenderAttr("srcset", slide.mobile_image_url)} media="(max-width: 639px)"${_scopeId3}>`);
                              } else {
                                _push4(`<!---->`);
                              }
                              _push4(`<img${ssrRenderAttr("src", slide.image_url)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="h-full w-auto max-w-none 2xl:w-full 2xl:object-fill"${_scopeId3}></picture>`);
                            } else {
                              return [
                                createVNode("picture", { class: "block h-full w-full ring" }, [
                                  slide.mobile_image_url ? (openBlock(), createBlock("source", {
                                    key: 0,
                                  ...
                                  createVNode("img", {
                                    src: slide.image_url,
                                    alt: `main ${i + 1}`,
                                    class: "h-full w-auto max-w-none 2xl:w-full 2xl:object-fill"
                                  }, null, 8, ["src", "alt"])
                                ])
                              ];
                            }
                        ...
                        return [
                          (openBlock(), createBlock(resolveDynamicComponent(slideHref(slide) ? unref(Link) : "div"), {
                            href: slideHref(slide),
                            class: "block h-full w-full"
                          }, {
                            default: withCtx(() => [
          ...
          _push(`<picture class="block h-full w-full">`);
          if (mainSrc.value[0].mobile_image_url) {
            _push(`<source${ssrRenderAttr("srcset", mainSrc.value[0].mobile_image_url)} media="(max-width: 639px)">`);
          } else {
            _push(`<!---->`);
          }
          _push(`<img${ssrRenderAttr("src", mainSrc.value[0].image_url)} alt="main" class="h-full w-auto max-w-none 2xl:w-full 2xl:object-fill"></picture>`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="grid grid-cols-1 sm:grid-cols-2 gap-3 min-h-0 min-w-0"><div class="relative rounded-xl overflow-hidden min-h-0 max-sm:h-56">`);
      if (mounted.value) {
        _push(ssrRenderComponent(unref(Swiper), {
          modules,
          "slides-per-view": 1,
        ...
        _push(`<img${ssrRenderAttr("src", doorSrc.value[0])} alt="door" class="w-full h-full object-cover">`);
      }
      _push(`<div class="absolute bottom-0 left-0 right-0 p-4 z-10 flex items-center justify-between bg-black/50"><div><p class="text-white font-semibold text-sm">${ssrInterpolate(_ctx.$t("promo.doorsTitle"))}</p><p class="text-white/90 text-xs">${ssrInterpolate(_ctx.$t("promo.doorsText"))}</p></div><a href="https://frame.sonniva.ge/ka/doors" target="_blank" rel="noopener noreferrer" class="flex items-center gap-x-1.5 shrink-0 bg-white/20 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-full hover:bg-white/30 transition-colors"><span>${ssrInterpolate(_ctx.$t("common.view"))}</span><i class="pi pi-external-link text-xs"></i></a></div></div><div class="relative rounded-xl overflow-hidden min-h-0 max-sm:h-56">`);
      if (mounted.value) {
        _push(ssrRenderComponent(unref(Swiper), {
          modules,
          "slides-per-view": 1,
        ...
        _push(`<img${ssrRenderAttr("src", frameSrc.value[0])} alt="frame" class="w-full h-full object-cover">`);
      }
      _push(`<div class="absolute bottom-0 left-0 right-0 p-4 z-10 flex items-center justify-between bg-black/50"><div><p class="text-white font-semibold text-sm">${ssrInterpolate(_ctx.$t("promo.framesTitle"))}</p><p class="text-white/90 text-xs">${ssrInterpolate(_ctx.$t("promo.framesText"))}</p></div><a href="https://frame.sonniva.ge/ka/frames/create" target="_blank" rel="noopener noreferrer" class="flex items-center gap-x-1.5 shrink-0 bg-white/20 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-full hover:bg-white/30 transition-colors"><span>${ssrInterpolate(_ctx.$t("common.view"))}</span><i class="pi pi-external-link text-xs"></i></a></div></div></div></div>`);
    };
  }
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (activeCategory.value && activeCategory.value.subs?.length) {
        ...
        _push(ssrRenderComponent(unref(Link), {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.$t("common.viewAll"))} <i class="pi pi-arrow-right text-xs!"${_scopeId}></i>`);
            } else {
              return [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.section.items?.length || __props.section.images?.length) {
        _push(`<div${ssrRenderAttrs(_attrs)}>`);
        if (__props.section.images?.length) {
          _push(`<div class="mt-10 px-4 mb-6">`);
          if (__props.section.gallery_title) {
            _push(`<h2 class="sm:text-lg font-semibold text-gray-800 mb-4">${ssrInterpolate(__props.section.gallery_title)}</h2>`);
          } else {
            _push(`<!---->`);
          }
          _push(ssrRenderComponent(unref(Swiper), {
            ...
            keyboard: true,
            loop: __props.section.images.length > 1,
            breakpoints: {
              320: { slidesPerView: 1 },
              640: { slidesPerView: 3 },
              ...
              if (_push2) {
                ...
                ssrRenderList(__props.section.images, (image) => {
                  _push2(ssrRenderComponent(unref(SwiperSlide), {
                    ...
                    default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                      if (_push3) {
                        ssrRenderVNode(_push3, createVNode(resolveDynamicComponent(image.link_url ? "a" : "div"), {
                          href: image.link_url || void 0,
                          class: "relative block h-[500px] rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-gray-100"
                        }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<img${ssrRenderAttr("src", image.image_url)}${ssrRenderAttr("alt", image.title || "")} class="w-full h-full object-cover"${_scopeId3}>`);
                              if (image.title) {
                                _push4(`<span class="absolute bottom-0 inset-x-0 px-3 py-2 text-sm font-medium text-white bg-black/50 truncate"${_scopeId3}>${ssrInterpolate(image.title)}</span>`);
                              } else {
                                _push4(`<!---->`);
                              }
                            } else {
                        ...
                        return [
                          (openBlock(), createBlock(resolveDynamicComponent(image.link_url ? "a" : "div"), {
                            href: image.link_url || void 0,
                            class: "relative block h-[500px] rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-gray-100"
                          }, {
                            default: withCtx(() => [
                ...
                return [
                  (openBlock(true), createBlock(Fragment, null, renderList(__props.section.images, (image) => {
                    return openBlock(), createBlock(unref(SwiperSlide), {
                      key: image.id
                    }, {
                      default: withCtx(() => [
        ...
        if (__props.section.items?.length) {
          _push(ssrRenderComponent(_sfc_main$4, {
            title: __props.section.carousel_title,
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Shared/components/HomeSection.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="description"${ssrRenderAttr("content", _ctx.$t("seo.homeDescription"))}${_scopeId}><meta property="og:type" content="website"${_scopeId}><meta property="og:site_name" content="Sonniva"${_scopeId}><meta property="og:title" content="Sonniva"${_scopeId}><meta property="og:description"${ssrRenderAttr("content", _ctx.$t("seo.homeDescription"))}${_scopeId}><meta property="og:url"${ssrRenderAttr("content", _ctx.$page.props.ziggy.location)}${_scopeId}><meta property="og:image"${ssrRenderAttr("content", `${_ctx.$page.props.ziggy.url}/logo/logo.png`)}${_scopeId}>`);
          } else {
            return [
              createVNode("meta", {
                name: "description",
                content: _ctx.$t("seo.homeDescription")
              }, null, 8, ["content"]),
              createVNode("meta", {
                property: "og:type",
                content: "website"
      ...
      _push(`<div class="flex-1 min-w-0 rounded-lg">`);
      _push(ssrRenderComponent(_sfc_main$3, null, null, _parent));
      _push(`</div></div><div class="flex flex-col"><!--[-->`);
      ssrRenderList(__props.homeSections, (section) => {
...
//# sourceMappingURL=Index-BwNWRRoE.js.map
