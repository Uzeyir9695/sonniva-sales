...
import { u as useReorder, _ as _sfc_main$1 } from "./OrderDetailDialog-DcsP6-ww.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.orders?.data?.some((o) => o.tracking_number)) {
              _push2(`<div class="flex flex-col sm:flex-row sm:items-center gap-2 bg-blue-50 text-blue-700 text-sm px-4 py-3 mb-4 rounded-xl"${_scopeId}><div class="flex items-start gap-2"${_scopeId}><i class="pi pi-info-circle mt-0.5 shrink-0"${_scopeId}></i><span${_scopeId}>შეკვეთის სტატუსის სანახავად დააკოპირეთ თრექინგის ნომერი და მოძებნეთ Onway-ის საიტზე:</span></div><a href="https://onway.ge/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1.5 font-semibold underline underline-offset-5 shrink-0"${_scopeId}><i class="pi pi-external-link text-xs"${_scopeId}></i><span${_scopeId}>ვებგვერდზე გადასვლა</span></a></div>`);
            } else {
              _push2(`<!---->`);
            }
                    ...
                    body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_Button, {
                          ...
                          onClick: ($event) => unref(reorder)(data.id)
                        }, null, _parent4, _scopeId3));
                        _push4(`</div>`);
                      } else {
                        return [
            ...
            return [
              __props.orders?.data?.some((o) => o.tracking_number) ? (openBlock(), createBlock("div", {
                ...
                createVNode("a", {
                  ...
                  createVNode("span", null, "ვებგვერდზე გადასვლა")
                ])
...
//# sourceMappingURL=Index-CtawmVfY.js.map
