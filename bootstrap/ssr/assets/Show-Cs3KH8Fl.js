  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Panel, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ul class="space-y-2 text-xs text-gray-600"${_scopeId}><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span><span${_scopeId}><strong${_scopeId}>${ssrInterpolate(_ctx.$t("item.deliverySelfPickup"))}</strong> ${ssrInterpolate(_ctx.$t("item.deliverySelfPickupText"))} <a href="https://maps.app.goo.gl/3YwH55CnhUUfJoYQ9" target="_blank" class="text-blue-500 hover:underline"${_scopeId}>${ssrInterpolate(_ctx.$t("item.onMap"))}</a></span></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span> <span${_scopeId}>${ssrInterpolate(_ctx.$t("item.deliveryTbilisi"))}</span></li><li class="flex gap-2"${_scopeId}><span class="text-brand-500"${_scopeId}>→</span><span${_scopeId}>${ssrInterpolate(_ctx.$t("item.deliveryRegions"))} `);
...
//# sourceMappingURL=Show-Cs3KH8Fl.js.map
