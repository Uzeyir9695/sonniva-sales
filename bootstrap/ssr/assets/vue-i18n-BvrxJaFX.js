import { effectScope, computed, watch, isRef, getCurrentScope, onScopeDispose, ref, shallowRef, defineComponent, h, getCurrentInstance as getCurrentInstance$1, inject, onMounted, onUnmounted, Fragment, createVNode, Text } from "vue";
...
function resolveFormatLocale(context, key, locale, formats, missingWarn, fallbackWarn, type) {
  ...
  for (let i = 0; i < locales.length; i++) {
    ...
    if (process.env.NODE_ENV !== "production" && locale !== targetLocale && isTranslateFallbackWarn(fallbackWarn, key)) {
      onWarn(getWarnMessage$1(type === "datetime format" ? CoreWarnCodes.FALLBACK_TO_DATE_FORMAT : CoreWarnCodes.FALLBACK_TO_NUMBER_FORMAT, {
        key,
        target: targetLocale
      }));
    }
...
//# sourceMappingURL=vue-i18n-BvrxJaFX.js.map
