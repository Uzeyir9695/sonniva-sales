...
import { ref, unref, withCtx, openBlock, createBlock, createVNode, createCommentVNode, toDisplayString, Fragment, renderList, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
import { Head, Deferred } from "@inertiajs/vue3";
import { _ as _sfc_main$3 } from "./Paginate-DBEcn-DS.js";
import _sfc_main$1 from "./OrderDetailDialog-1Tm2ZrTL.js";
import _sfc_main$2 from "./ReorderDialog-DJKA7zkF.js";
      ...
      _push(ssrRenderComponent(unref(Deferred), { data: "orders" }, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(6, (n) => {
              _push2(`<div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex flex-col gap-4"${_scopeId}><div class="flex items-start justify-between gap-2"${_scopeId}>`);
              ...
              _push2(`<!--]--></div><div class="grid grid-cols-2 gap-3 border-t border-gray-100 pt-3"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Skeleton, {
                height: "0.7rem",
                width: "70%",
                class: "bg-gray-100!",
              ...
              createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" }, [
                (openBlock(), createBlock(Fragment, null, renderList(6, (n) => {
                  return createVNode("div", {
                    ...
                    createVNode("div", { class: "grid grid-cols-2 gap-3 border-t border-gray-100 pt-3" }, [
                      createVNode(_component_Skeleton, {
                        height: "0.7rem",
                        width: "70%",
                        class: "bg-gray-100!",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (__props.orders.data?.length) {
              ...
              ssrRenderList(__props.orders.data, (order) => {
                ...
                if (order.items?.length) {
                  ...
                  ssrRenderList(visibleImages(order), (orderItem) => {
                    ...
                    if (orderItem.image) {
                      _push2(`<img${ssrRenderAttr("src", imageUrl(orderItem.image))}${ssrRenderAttr("alt", orderItem.name)} class="w-full h-full object-cover rounded-lg"${_scopeId}>`);
                    } else {
                  ...
                  _push2(`<span class="text-xs text-gray-300"${_scopeId}>პროდუქტები არ მოიძებნა</span>`);
                }
                _push2(`</div><div class="grid grid-cols-2 gap-y-2 gap-x-3 text-sm border-t border-gray-100 pt-3"${_scopeId}><div${_scopeId}><p class="text-xs text-gray-400"${_scopeId}>თარიღი</p><p class="text-gray-700"${_scopeId}>${ssrInterpolate(order.created_at)}</p></div><div${_scopeId}><p class="text-xs text-gray-400"${_scopeId}>სულ</p><p class="font-semibold text-gray-900"${_scopeId}>${ssrInterpolate(order.total)} ₾</p></div>`);
                if (order.tracking_number) {
                  _push2(`<div class="col-span-2"${_scopeId}><p class="text-xs text-gray-400"${_scopeId}>თრექინგის ნომერი</p><p class="font-mono text-gray-700"${_scopeId}>${ssrInterpolate(order.tracking_number)}</p></div>`);
                } else {
                  _push2(`<!---->`);
                }
              ...
              _push2(`<div class="flex flex-col items-center justify-center h-60 bg-white rounded-2xl border border-gray-100 shadow-sm"${_scopeId}><i class="pi pi-inbox text-5xl text-gray-300 mb-3"${_scopeId}></i><p class="text-gray-500"${_scopeId}>შეკვეთები არ მოიძებნა.</p></div>`);
            }
            ...
            return [
              ...
              createVNode("div", { class: "flex items-center gap-2 mb-4" }, [
                createVNode("span", { class: "font-semibold text-gray-700 text-sm" }, toDisplayString(__props.orders.total ?? __props.orders.data.length) + " შეკვეთა ", 1)
              ]),
                  ...
                  return openBlock(), createBlock("div", {
                    ...
                    createVNode("div", { class: "flex items-start justify-between gap-2" }, [
                      createVNode("div", null, [
                        createVNode("p", { class: "text-xs text-gray-400" }, "შეკვეთის №"),
                    ...
                    createVNode("div", { class: "grid grid-cols-2 gap-y-2 gap-x-3 text-sm border-t border-gray-100 pt-3" }, [
                      createVNode("div", null, [
                        createVNode("p", { class: "text-xs text-gray-400" }, "თარიღი"),
                        createVNode("p", { class: "text-gray-700" }, toDisplayString(order.created_at), 1)
                      ]),
                      createVNode("div", null, [
                        createVNode("p", { class: "text-xs text-gray-400" }, "სულ"),
                        createVNode("p", { class: "font-semibold text-gray-900" }, toDisplayString(order.total) + " ₾", 1)
                      ]),
                      order.tracking_number ? (openBlock(), createBlock("div", {
                        key: 0,
                        class: "col-span-2"
                      }, [
                        createVNode("p", { class: "text-xs text-gray-400" }, "თრექინგის ნომერი"),
...
//# sourceMappingURL=Index-DkSzT27e.js.map
