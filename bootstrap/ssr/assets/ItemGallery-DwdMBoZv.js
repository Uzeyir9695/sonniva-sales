...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrRenderComponent, ssrRenderList, ssrRenderAttr } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!slides.value.length) {
        _push(`<div class="w-full rounded-3xl border border-gray-100 shadow-sm h-[270px] sm:h-[500px] bg-gray-50 flex flex-col items-center justify-center gap-3 text-gray-300"><i class="pi pi-image text-6xl"></i><span class="text-sm">${ssrInterpolate(_ctx.$t("gallery.noImage"))}</span></div>`);
      } else {
...
//# sourceMappingURL=ItemGallery-DwdMBoZv.js.map
