        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (loading.value) {
              ...
              _push2(`<div class="flex items-center justify-end gap-6 px-4 py-3 border-t border-gray-200 bg-gray-50"${_scopeId}><span class="text-gray-500"${_scopeId}>Subtotal: <span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.subtotal)} ₾</span></span><span class="text-gray-800 font-bold"${_scopeId}> Total: <span class="text-brand-600 text-base"${_scopeId}>${ssrInterpolate(order.value.total)} ₾</span></span></div></div><div class="flex gap-2 flex-wrap pt-1"${_scopeId}>`);
              ...
              if (order.value.payment?.invoice_no) {
            ...
            return [
              loading.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "border border-gray-200 rounded-xl overflow-hidden mb-4" }, [
                  ...
                  createVNode("div", { class: "flex items-center justify-end gap-6 px-4 py-3 border-t border-gray-200 bg-gray-50" }, [
                    ...
                    createVNode("span", { class: "text-gray-800 font-bold" }, [
                ...
                createVNode("div", { class: "flex gap-2 flex-wrap pt-1" }, [
                  ...
                  order.value.payment?.invoice_no ? (openBlock(), createBlock("a", {
                    key: 3,
...
//# sourceMappingURL=OrderDetailDialog-C7VuNN7L.js.map
