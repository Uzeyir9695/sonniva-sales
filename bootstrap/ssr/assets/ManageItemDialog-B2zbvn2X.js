        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (editingItem.value) {
              ...
              _push2(`</div><div${_scopeId}><label class="text-sm font-semibold text-gray-500 mb-1 block"${_scopeId}>Increased Real Price (₾)</label>`);
              _push2(ssrRenderComponent(unref(script$1), {
                modelValue: unref(manageForm).unit_price_override,
                "onUpdate:modelValue": ($event) => unref(manageForm).unit_price_override = $event,
                min: 0,
                "min-fraction-digits": 0,
                "max-fraction-digits": 2,
                suffix: " ₾",
                placeholder: "0",
                invalid: !!unref(manageForm).errors.unit_price_override,
                showClear: "",
                fluid: ""
              }, null, _parent2, _scopeId));
              if (unref(manageForm).errors.unit_price_override) {
                _push2(`<p class="text-xs text-red-500 mt-1"${_scopeId}>${ssrInterpolate(unref(manageForm).errors.unit_price_override)}</p>`);
              } else {
                _push2(`<p class="text-xs text-gray-400 mt-1"${_scopeId}>Must be higher than the Business Central price (${ssrInterpolate(Number(editingItem.value.bc_unit_price).toFixed(2))} ₾). Overwrites the real charged price everywhere - cart, checkout, orders, invoices - and survives the automatic BC price sync. Leave empty to keep charging the BC price.</p>`);
              }
            ...
            return [
              editingItem.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", null, [
                  createVNode("label", { class: "text-sm font-semibold text-gray-500 mb-1 block" }, "Increased Real Price (₾)"),
                  ...
                  unref(manageForm).errors.unit_price_override ? (openBlock(), createBlock("p", {
                    key: 0,
                    class: "text-xs text-red-500 mt-1"
                  }, toDisplayString(unref(manageForm).errors.unit_price_override), 1)) : (openBlock(), createBlock("p", {
                    key: 1,
                    class: "text-xs text-gray-400 mt-1"
                  }, "Must be higher than the Business Central price (" + toDisplayString(Number(editingItem.value.bc_unit_price).toFixed(2)) + " ₾). Overwrites the real charged price everywhere - cart, checkout, orders, invoices - and survives the automatic BC price sync. Leave empty to keep charging the BC price.", 1))
                ]),
                createVNode("div", null, [
...
//# sourceMappingURL=ManageItemDialog-B2zbvn2X.js.map
