    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-c5e17ade${_scopeId}>${ssrInterpolate(_ctx.$t("auth.loginTitle"))}</title>`);
          } else {
            return [
      ...
      _push(`<div class="w-full max-w-md mx-auto mt-6" data-v-c5e17ade><div class="bg-white mx-3 rounded-xl shadow-lg transition-shadow duration-500 ease-in-out border border-slate-200 p-8" data-v-c5e17ade><h1 class="text-2xl font-bold mb-6 text-center" data-v-c5e17ade>${ssrInterpolate(_ctx.$t("auth.loginHeading"))}</h1>`);
      ...
      _push(`<form data-v-c5e17ade><div class="space-y-5" data-v-c5e17ade>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-envelope" data-v-c5e17ade${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="email_or_phone" data-v-c5e17ade${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.emailOrPhone"))}</label>`);
                } else {
                  return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-lock" data-v-c5e17ade${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password" class="${ssrRenderClass({ "text-danger": unref(form).errors.password })}" data-v-c5e17ade${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.password"))}</label>`);
                } else {
                  return [
      ...
      _push(`<div class="flex items-center justify-between" data-v-c5e17ade><div class="flex items-center gap-2" data-v-c5e17ade>`);
      ...
      _push(`<label for="remember" class="text-sm max-sm:text-xs!" data-v-c5e17ade>${ssrInterpolate(_ctx.$t("auth.rememberMe"))}</label></div>`);
      ...
      _push(`</div></div></form><div class="mt-6" data-v-c5e17ade>`);
      _push(ssrRenderComponent(unref(script$8), null, null, _parent));
      _push(`<p class="text-center text-sm" data-v-c5e17ade>${ssrInterpolate(_ctx.$t("auth.noAccount"))} `);
      _push(ssrRenderComponent(unref(Link), {
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c5e17ade"]]);
export {
  Login as default
};
//# sourceMappingURL=Login-C6k87dOJ.js.map
