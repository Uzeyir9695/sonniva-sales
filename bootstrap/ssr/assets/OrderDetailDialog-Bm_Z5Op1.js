import { s as script$4 } from "./index-YvTnrAwi.js";
import { s as script$2, a as script$3 } from "./index-BVLrsogj.js";
import { s as script$1 } from "./index-C0PiRRRi.js";
import { s as script } from "./index-D46B4f3g.js";
import { ref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createTextVNode, createCommentVNode, unref, useSSRContext } from "vue";
  ...
  setup(__props, { expose: __expose }) {
    ...
    function submitDispatch() {
      ...
      router.put(route("admin.orders.dispatch", order.value.id), {
        ...
        preserveScroll: true,
        onSuccess: () => {
          toast.add({ severity: "success", summary: "Updated", detail: "Order marked as dispatched.", life: 3e3 });
          visible.value = false;
        },
        onError: () => {
          toast.add({ severity: "error", summary: "Error", detail: "Failed to update status.", life: 3e3 });
    ...
    return (_ctx, _push, _parent, _attrs) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (loading.value) {
              ...
              if (order.value.branch) {
                _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-building text-xs text-brand-400"${_scopeId}></i> Pickup: <span class="font-medium text-gray-700 ml-1 capitalize"${_scopeId}>${ssrInterpolate(sonnivaBranchLabel[order.value.branch] ? `Sonniva Office - ${sonnivaBranchLabel[order.value.branch]}` : `${order.value.branch} Office`)}</span></p>`);
              } else {
                _push2(`<!---->`);
              }
              if (order.value.city) {
                _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-map-marker text-xs text-brand-400"${_scopeId}></i> City: ${ssrInterpolate(order.value.city)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              ...
              _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-tag text-xs text-brand-400"${_scopeId}></i> Delivery: <span class="font-medium text-gray-700 ml-1"${_scopeId}>${ssrInterpolate(order.value.delivery_cost)} ₾</span></p>`);
              if (order.value.tracking_number) {
                _push2(`<p class="flex items-center gap-1.5 text-gray-500"${_scopeId}><i class="pi pi-hashtag text-xs text-brand-400"${_scopeId}></i> Tracking #: <span class="font-mono font-medium text-gray-700 ml-1"${_scopeId}>${ssrInterpolate(order.value.tracking_number)}</span></p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div></div></div>`);
              if (order.value.payment) {
                _push2(`<div class="border border-blue-200 rounded-xl overflow-hidden mb-4"${_scopeId}><div class="flex items-center gap-2 bg-blue-50 border-b border-blue-200 px-3 py-2"${_scopeId}><i class="pi pi-credit-card text-blue-500 text-xs"${_scopeId}></i><span class="font-semibold text-blue-700 text-xs uppercase tracking-wide"${_scopeId}>Payment</span></div><div class="px-3 py-3 flex flex-wrap gap-5 text-gray-600"${_scopeId}><div${_scopeId}><p class="text-xs text-gray-400 mb-0.5"${_scopeId}>Provider</p><p class="font-semibold text-gray-800"${_scopeId}>${ssrInterpolate(providerLabel[order.value.payment.provider] ?? order.value.payment.provider)}</p></div><div${_scopeId}><p class="text-xs text-gray-400 mb-0.5"${_scopeId}>Payment Status</p>`);
                _push2(ssrRenderComponent(_component_Tag, {
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="flex flex-col gap-0.5"${_scopeId3}><span${_scopeId3}>${ssrInterpolate(data.item_name)}</span>`);
                          if (data.with_service) {
                            _push4(`<span class="inline-flex items-center gap-1 text-xs font-medium text-brand-600 bg-brand-50 px-1.5 py-0.5 rounded-full w-fit"${_scopeId3}><i class="pi pi-wrench text-xs"${_scopeId3}></i> Setup service — ${ssrInterpolate(data.service_price)} ₾ </span>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</div>`);
                          ...
                          return [
                            createVNode("div", { class: "flex flex-col gap-0.5" }, [
                              createVNode("span", null, toDisplayString(data.item_name), 1),
                              data.with_service ? (openBlock(), createBlock("span", {
                                ...
                                createTextVNode(" Setup service — " + toDisplayString(data.service_price) + " ₾ ", 1)
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span class="text-gray-500"${_scopeId3}>${ssrInterpolate((data.unit_weight * data.quantity).toFixed(3))} kg</span>`);
                        } else {
                          return [
                            createVNode("span", { class: "text-gray-500" }, toDisplayString((data.unit_weight * data.quantity).toFixed(3)) + " kg", 1)
                          ];
                        }
                      }),
                      _: 1
                        ...
                        if (_push4) {
                          ...
                          return [
                            data.wholesale_discount > 0 ? (openBlock(), createBlock("div", {
                              ...
                              createVNode("span", { class: "text-[10px] px-1.5 py-0.5 rounded-full bg-emerald-100 text-emerald-700 font-semibold w-fit" }, "Wholesale")
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          if (data.wholesale_discount > 0) {
                            _push4(`<div class="flex items-center gap-1.5"${_scopeId3}><span class="line-through text-gray-400 text-xs"${_scopeId3}>${ssrInterpolate((Number(data.subtotal) + Number(data.wholesale_discount)).toFixed(2))} ₾</span><span class="font-semibold text-emerald-600"${_scopeId3}>${ssrInterpolate(data.subtotal)} ₾</span></div>`);
                          } else if (data.discount > 0) {
                            _push4(`<div class="flex items-center gap-1.5"${_scopeId3}><span class="line-through text-gray-400 text-xs"${_scopeId3}>${ssrInterpolate((Number(data.subtotal) / (1 - Number(data.discount) / 100)).toFixed(2))} ₾</span><span class="font-semibold text-red-600"${_scopeId3}>${ssrInterpolate(data.subtotal)} ₾</span></div>`);
                          } else if (data.fake_price > 0) {
                            _push4(`<div class="flex items-center gap-1.5"${_scopeId3}><span class="line-through text-gray-400 text-xs"${_scopeId3}>${ssrInterpolate((Number(data.fake_price) * Number(data.quantity)).toFixed(2))} ₾</span><span class="font-semibold text-red-600"${_scopeId3}>${ssrInterpolate(data.subtotal)} ₾</span></div>`);
                          } else {
                          ...
                          return [
                            data.wholesale_discount > 0 ? (openBlock(), createBlock("div", {
                              ...
                              createVNode("span", { class: "line-through text-gray-400 text-xs" }, toDisplayString((Number(data.subtotal) + Number(data.wholesale_discount)).toFixed(2)) + " ₾", 1),
                              createVNode("span", { class: "font-semibold text-emerald-600" }, toDisplayString(data.subtotal) + " ₾", 1)
                            ])) : data.discount > 0 ? (openBlock(), createBlock("div", {
                              key: 1,
                              class: "flex items-center gap-1.5"
                            }, [
                              createVNode("span", { class: "line-through text-gray-400 text-xs" }, toDisplayString((Number(data.subtotal) / (1 - Number(data.discount) / 100)).toFixed(2)) + " ₾", 1),
                              createVNode("span", { class: "font-semibold text-red-600" }, toDisplayString(data.subtotal) + " ₾", 1)
                            ])) : data.fake_price > 0 ? (openBlock(), createBlock("div", {
                              key: 2,
                              class: "flex items-center gap-1.5"
                            }, [
                              createVNode("span", { class: "line-through text-gray-400 text-xs" }, toDisplayString((Number(data.fake_price) * Number(data.quantity)).toFixed(2)) + " ₾", 1),
                              createVNode("span", { class: "font-semibold text-red-600" }, toDisplayString(data.subtotal) + " ₾", 1)
                            ])) : (openBlock(), createBlock("span", {
                              key: 3,
                              class: "font-semibold text-gray-800"
                            }, toDisplayString(data.subtotal) + " ₾", 1))
                          ];
                        }
                      }),
                      _: 1
              ...
              _push2(`<div class="flex justify-between text-sm text-gray-500"${_scopeId}><span${_scopeId}>Delivery</span><span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.delivery_cost)} ₾</span></div><div class="flex justify-between text-sm text-gray-500"${_scopeId}><span${_scopeId}>Total weight</span><span class="font-medium text-gray-700"${_scopeId}>${ssrInterpolate(order.value.items.reduce((s, i) => s + i.unit_weight * i.quantity, 0).toFixed(3))} kg</span></div><div class="flex justify-between text-sm font-bold text-gray-800 border-t border-gray-200 pt-1.5 mt-1"${_scopeId}><span${_scopeId}>Total</span><span class="text-brand-600 text-base"${_scopeId}>${ssrInterpolate(order.value.total)} ₾</span></div></div></div><div class="flex gap-2 flex-wrap pt-1"${_scopeId}>`);
              ...
              if (order.value.status === "dispatched") {
                _push2(ssrRenderComponent(_component_Button, {
                  ...
                  severity: "success",
                  size: "small",
                  onClick: ($event) => confirmStatusChange("delivered")
                }, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              if (!["cancelled", "ready", "delivered"].includes(order.value.status)) {
                _push2(ssrRenderComponent(_component_Button, {
                  label: "Cancel Order",
                  icon: "pi pi-times",
                  severity: "danger",
              ...
              loading.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4" }, [
                  ...
                  createVNode("div", { class: "border border-gray-200 rounded-xl overflow-hidden" }, [
                    ...
                    createVNode("div", { class: "px-3 py-3 space-y-1.5" }, [
                      ...
                      order.value.branch ? (openBlock(), createBlock("p", {
                        key: 0,
                        class: "flex items-center gap-1.5 text-gray-500"
                      }, [
                        createVNode("i", { class: "pi pi-building text-xs text-brand-400" }),
                        createTextVNode(" Pickup: "),
                        createVNode("span", { class: "font-medium text-gray-700 ml-1 capitalize" }, toDisplayString(sonnivaBranchLabel[order.value.branch] ? `Sonniva Office - ${sonnivaBranchLabel[order.value.branch]}` : `${order.value.branch} Office`), 1)
                      ])) : createCommentVNode("", true),
                      order.value.city ? (openBlock(), createBlock("p", {
                        key: 1,
                        class: "flex items-center gap-1.5 text-gray-500"
                      }, [
                        createVNode("i", { class: "pi pi-map-marker text-xs text-brand-400" }),
                        createTextVNode(" City: " + toDisplayString(order.value.city), 1)
                      ])) : createCommentVNode("", true),
                      ...
                      order.value.tracking_number ? (openBlock(), createBlock("p", {
                        ...
                        createVNode("span", { class: "font-mono font-medium text-gray-700 ml-1" }, toDisplayString(order.value.tracking_number), 1)
                      ])) : createCommentVNode("", true)
                    ])
                  ])
                ]),
                order.value.payment ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("div", { class: "px-3 py-3 flex flex-wrap gap-5 text-gray-600" }, [
                    ...
                    createVNode("div", null, [
                      createVNode("p", { class: "text-xs text-gray-400 mb-0.5" }, "Payment Status"),
                      createVNode(_component_Tag, {
                        value: order.value.payment.status,
                        class: "capitalize text-xs",
                        severity: order.value.payment.status === "completed" ? "success" : "warn"
                ...
                createVNode("div", { class: "border border-gray-200 rounded-xl overflow-hidden mb-4" }, [
                  ...
                  createVNode("div", { class: "px-4 py-3 border-t border-gray-200 bg-gray-50 space-y-1.5" }, [
                    ...
                    createVNode("div", { class: "flex justify-between text-sm text-gray-500" }, [
                      createVNode("span", null, "Total weight"),
                      createVNode("span", { class: "font-medium text-gray-700" }, toDisplayString(order.value.items.reduce((s, i) => s + i.unit_weight * i.quantity, 0).toFixed(3)) + " kg", 1)
                    ]),
                ...
                createVNode("div", { class: "flex gap-2 flex-wrap pt-1" }, [
                  ...
                  order.value.status === "dispatched" ? (openBlock(), createBlock(_component_Button, {
                    key: 2,
                    label: "Mark Delivered",
                    icon: "pi pi-verified",
                    severity: "success",
                  ...
                  !["cancelled", "ready", "delivered"].includes(order.value.status) ? (openBlock(), createBlock(_component_Button, {
                    key: 3,
                    label: "Cancel Order",
                    icon: "pi pi-times",
                    severity: "danger",
      ...
      _push(ssrRenderComponent(_component_Dialog, {
        visible: dispatchDialogVisible.value,
        "onUpdate:visible": ($event) => dispatchDialogVisible.value = $event,
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Button, {
              ...
              severity: "secondary",
              variant: "text",
              onClick: ($event) => dispatchDialogVisible.value = false
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_Button, {
              label: "Mark Dispatched",
              size: "small",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex flex-col gap-3 py-2"${_scopeId}><p class="text-sm text-gray-600"${_scopeId}> Mark order ${ssrInterpolate(order.value?.invoice_no ?? order.value?.id?.slice(0, 8))} as dispatched? </p><div class="flex flex-col gap-1.5"${_scopeId}><label for="detailTrackingNumber" class="text-xs font-medium text-gray-500"${_scopeId}>Tracking number (optional)</label>`);
            _push2(ssrRenderComponent(_sfc_main$1, {
              id: "detailTrackingNumber",
            ...
            return [
              createVNode("div", { class: "flex flex-col gap-3 py-2" }, [
                createVNode("p", { class: "text-sm text-gray-600" }, " Mark order " + toDisplayString(order.value?.invoice_no ?? order.value?.id?.slice(0, 8)) + " as dispatched? ", 1),
                createVNode("div", { class: "flex flex-col gap-1.5" }, [
                  createVNode("label", {
                    for: "detailTrackingNumber",
...
//# sourceMappingURL=OrderDetailDialog-Bm_Z5Op1.js.map
