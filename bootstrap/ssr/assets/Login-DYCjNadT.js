...
import { s as script$1, a as script$2 } from "./index-Dc7gNevf.js";
import { s as script } from "./index-ByiP8O2w.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title data-v-9f79e3fb${_scopeId}>${ssrInterpolate(_ctx.$t("auth.loginTitle"))}</title>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(_ctx.$t("auth.loginTitle")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="w-full max-w-md mx-auto mt-6" data-v-9f79e3fb><div class="bg-white mx-3 rounded-xl shadow-lg transition-shadow duration-500 ease-in-out border border-slate-200 p-8" data-v-9f79e3fb><h1 class="text-2xl font-bold mb-6 text-center" data-v-9f79e3fb>${ssrInterpolate(_ctx.$t("auth.loginHeading"))}</h1>`);
      if (Object.keys(__props.errors).length > 0) {
        _push(`<div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex" data-v-9f79e3fb><i class="pi pi-exclamation-circle text-red-400 mr-3 mt-0.5" data-v-9f79e3fb></i><div class="text-red-600 text-sm" data-v-9f79e3fb><!--[-->`);
        ssrRenderList(__props.errors, (error, key) => {
          _push(`<p data-v-9f79e3fb>${ssrInterpolate(error)}</p>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      ...
      _push(`<form data-v-9f79e3fb><div class="space-y-5" data-v-9f79e3fb>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-envelope" data-v-9f79e3fb${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="email_or_phone" data-v-9f79e3fb${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.emailOrPhone"))}</label>`);
                } else {
                  return [
                    ...
                    createVNode("label", { for: "email_or_phone" }, toDisplayString(_ctx.$t("auth.emailOrPhone")), 1)
                  ];
                }
              }),
              _: 1
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_InputGroupAddon, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="pi pi-lock" data-v-9f79e3fb${_scopeId2}></i>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<label for="password" class="${ssrRenderClass({ "text-danger": unref(form).errors.password })}" data-v-9f79e3fb${_scopeId2}>${ssrInterpolate(_ctx.$t("auth.password"))}</label>`);
                } else {
                  return [
                    ...
                    }, toDisplayString(_ctx.$t("auth.password")), 3)
                  ];
                }
              }),
              _: 1
      ...
      _push(`<div class="flex items-center justify-between" data-v-9f79e3fb><div class="flex items-center gap-2" data-v-9f79e3fb>`);
      ...
      _push(`<label for="remember" class="text-sm max-sm:text-xs!" data-v-9f79e3fb>${ssrInterpolate(_ctx.$t("auth.rememberMe"))}</label></div>`);
      ...
      _push(`</div><div data-v-9f79e3fb>`);
      _push(ssrRenderComponent(_component_Button, {
        type: "submit",
        icon: "pi pi-user",
        label: _ctx.$t("auth.signIn"),
      ...
      _push(`</div></div></form><div class="mt-6" data-v-9f79e3fb>`);
      _push(ssrRenderComponent(unref(script$8), null, null, _parent));
      _push(`<p class="text-center text-sm" data-v-9f79e3fb>${ssrInterpolate(_ctx.$t("auth.noAccount"))} `);
      _push(ssrRenderComponent(unref(Link), {
...
const Login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9f79e3fb"]]);
export {
  Login as default
};
//# sourceMappingURL=Login-DYCjNadT.js.map
