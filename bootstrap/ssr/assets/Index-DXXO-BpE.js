    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Deferred), { data: "users" }, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-4" data-v-12cbfbb0${_scopeId}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.users.length > 0) {
              _push2(`<div class="rounded-xl overflow-hidden" data-v-12cbfbb0${_scopeId}>`);
              _push2(ssrRenderComponent(_component_DataTable, {
                ...
                header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex justify-between" data-v-12cbfbb0${_scopeId2}><div class="flex flex-wrap items-center justify-between gap-2" data-v-12cbfbb0${_scopeId2}><div data-v-12cbfbb0${_scopeId2}><h2 class="text-lg font-semibold text-gray-900" data-v-12cbfbb0${_scopeId2}>${ssrInterpolate(__props.usersCount)} Users</h2></div><h1 class="text-lg text-green-500" data-v-12cbfbb0${_scopeId2}>- ${ssrInterpolate(__props.onlineUsers)} Online</h1></div><div class="flex items-center gap-3" data-v-12cbfbb0${_scopeId2}><div class="text-end" data-v-12cbfbb0${_scopeId2}>`);
                  ...
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      footer: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="space-x-1 inline-block mb-6" data-v-12cbfbb0${_scopeId3}><i class="pi pi-calculator text-sm" data-v-12cbfbb0${_scopeId3}></i><span class="font-semibold text-gray-500" data-v-12cbfbb0${_scopeId3}>Totals</span><div class="font-semibold text-blue-500" data-v-12cbfbb0${_scopeId3}>${ssrInterpolate(_ctx.$formatNumber(
                    ...
                    _push3(ssrRenderComponent(_component_Column, {
                      ...
                      body: withCtx(({ data }, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<span data-v-12cbfbb0${_scopeId3}>${ssrInterpolate(data.is_handyman ? "Yes" : "No")}</span>`);
                        } else {
                          return [
                    ...
                    if (isAdmin.value) {
                      _push3(ssrRenderComponent(_component_Column, { header: "Actions" }, {
                        body: withCtx((slotProps, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<div class="flex gap-2" data-v-12cbfbb0${_scopeId3}>`);
              ...
              _push2(`<div class="flex flex-col items-center justify-center h-64" data-v-12cbfbb0${_scopeId}><i class="pi pi-users text-6xl text-gray-400 mb-4" data-v-12cbfbb0${_scopeId}></i><h3 class="text-xl text-gray-600" data-v-12cbfbb0${_scopeId}>No users found.</h3></div>`);
            }
          } else {
            return [
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-12cbfbb0"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-DXXO-BpE.js.map
