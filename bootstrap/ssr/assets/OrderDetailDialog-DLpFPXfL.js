          ...
          if (_push2) {
            if (loading.value) {
              ...
              ssrRenderList(order.value.items, (data) => {
                ...
                if (data.image) {
                  _push2(`<img${ssrRenderAttr("src", imageUrl(data.image))}${ssrRenderAttr("alt", data.item_name)} class="w-full h-full object-cover rounded-lg"${_scopeId}>`);
                } else {
...
//# sourceMappingURL=OrderDetailDialog-DLpFPXfL.js.map
