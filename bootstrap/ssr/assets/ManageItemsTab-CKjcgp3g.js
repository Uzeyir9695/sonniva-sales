...
import _sfc_main$2 from "./ItemsListing-B7TpBrIZ.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex items-center justify-between mb-1"><h2 class="text-base font-bold text-gray-900">Manage Item</h2>`);
...
//# sourceMappingURL=ManageItemsTab-CKjcgp3g.js.map
