...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "weglot-switcher relative" }, _attrs))}><button class="flex items-center justify-center md:w-8 md:h-8 lg:w-10 lg:h-10 gap-1.5 rounded-full text-gray-600 hover:bg-gray-100 transition-all cursor-pointer"><img${ssrRenderAttr("src", flagMap[currentLang.value])} class="w-6 h-4 object-cover rounded-xs shrink-0" alt=""><span data-wg-notranslate class="sm:hidden text-sm font-medium text-gray-600"><span>${ssrInterpolate(fullNameMap[currentLang.value] ?? currentLang.value.toUpperCase())}</span></span></button>`);
      if (open.value) {
...
const SmallDeviceMegaMenu = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-6d7023ff"]]);
const _sfc_main$5 = {
  __name: "SearchBar",
  __ssrInlineRender: true,
  props: {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="weglot-switcher"></div>`);
...
//# sourceMappingURL=index-ZioeOrFd.js.map
