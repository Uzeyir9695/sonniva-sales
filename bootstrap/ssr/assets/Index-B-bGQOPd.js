...
import _sfc_main$1 from "./OrderDetailDialog-VR4u9ihk.js";
import _sfc_main$2 from "./ReorderDialog-BbXZUQQb.js";
      ...
      _push(ssrRenderComponent(unref(Deferred), { data: ["orders", "ordersSummary"] }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="flex items-center justify-between gap-2 mb-4 flex-wrap"${_scopeId}><span class="font-semibold text-gray-700 text-sm"${_scopeId}>${ssrInterpolate(__props.orders.total ?? __props.orders.data.length)} შეკვეთა </span>`);
            if (__props.ordersSummary) {
              _push2(`<div class="flex flex-col items-end gap-1.5 text-sm"${_scopeId}><h5 class="font-semibold"${_scopeId}>ჯამური თანხა</h5><div class="flex items-center gap-1.5"${_scopeId}>`);
            ...
            if (__props.orders.data?.length) {
              ...
              ssrRenderList(__props.orders.data, (order) => {
                ...
                _push2(`</div><div class="grid grid-cols-2 gap-y-2 gap-x-3 text-sm border-t border-gray-100 pt-3"${_scopeId}><div${_scopeId}><p class="text-xs text-gray-400"${_scopeId}>თარიღი</p><p class="text-gray-700"${_scopeId}>${ssrInterpolate(order.created_at)}</p></div><div${_scopeId}><p class="text-xs text-gray-400"${_scopeId}>სულ</p>`);
            ...
            return [
              ...
              createVNode("div", { class: "flex items-center justify-between gap-2 mb-4 flex-wrap" }, [
                ...
                __props.ordersSummary ? (openBlock(), createBlock("div", {
                  ...
                  createVNode("h5", { class: "font-semibold" }, "ჯამური თანხა"),
...
//# sourceMappingURL=Index-B-bGQOPd.js.map
