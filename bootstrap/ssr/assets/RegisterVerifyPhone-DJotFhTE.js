    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>${ssrInterpolate(_ctx.$t("auth.verifyPhoneTitle"))}</title>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(_ctx.$t("auth.verifyPhoneTitle")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="bg-white flex flex-col justify-evenly mx-3 sm:mx-auto shadow-lg rounded-xl border border-slate-200 mt-8 w-full sm:w-[450px] h-[400px]"><form class="flex flex-col p-8 gap-6 self-center"><div class="flex flex-col items-center"><p class="text-surface-500 dark:text-surface-400 block mb-8">${ssrInterpolate(_ctx.$t("auth.enterSixDigitCode"))}</p>`);
...
//# sourceMappingURL=RegisterVerifyPhone-DJotFhTE.js.map
