...
import { _ as _sfc_main$1 } from "./AdminLayout-B97vdj-S.js";
import _sfc_main$2 from "./PrimeInputText-BlIRrCdA.js";
import { s as script$7 } from "./index-BgiqKOW-.js";
import { e as getOriginalPrice, g as getDisplayPrice } from "./usePricing-ssZPWxiP.js";
...
import "./QuickViewDialog-dZuTQhJP.js";
                  ...
                  _push3(ssrRenderComponent(_component_TabPanel, { value: "0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<hr class="my-6 border-gray-100"${_scopeId3}><div class="grid grid-cols-1 sm:grid-cols-2 gap-4"${_scopeId3}><div class="flex flex-col rounded-2xl border-2 border-amber-200 bg-amber-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-tags"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Item Attributes</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Updates item attribute values (e.g. size, color) from Business Central. </p>`);
                        _push4(ssrRenderComponent(_component_Button, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (editingItem.value) {
              ...
              _push2(`</div><div${_scopeId}><label class="text-sm font-semibold text-gray-500 mb-1 block"${_scopeId}>Increased Price (₾)</label>`);
              ...
              if (unref(manageForm).errors.fake_price) {
                ...
                _push2(`<p class="text-xs text-gray-400 mt-1"${_scopeId}>Must be higher than the unit price (${ssrInterpolate(Number(editingItem.value.unit_price).toFixed(2))} ₾). Shown to customers in place of the unit price; leave empty to disable.</p>`);
              }
              _push2(`</div><div${_scopeId}><label class="text-sm font-semibold text-gray-500 mb-1 block"${_scopeId}>Web Discount (in %)</label>`);
              _push2(ssrRenderComponent(unref(script$7), {
            ...
            return [
              editingItem.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", null, [
                  createVNode("label", { class: "text-sm font-semibold text-gray-500 mb-1 block" }, "Increased Price (₾)"),
                  ...
                  unref(manageForm).errors.fake_price ? (openBlock(), createBlock("p", {
                    ...
                    key: 1,
                    class: "text-xs text-gray-400 mt-1"
                  }, "Must be higher than the unit price (" + toDisplayString(Number(editingItem.value.unit_price).toFixed(2)) + " ₾). Shown to customers in place of the unit price; leave empty to disable.", 1))
                ]),
                createVNode("div", null, [
                  createVNode("label", { class: "text-sm font-semibold text-gray-500 mb-1 block" }, "Web Discount (in %)"),
                  createVNode(unref(script$7), {
                    modelValue: unref(manageForm).discount,
                    "onUpdate:modelValue": ($event) => unref(manageForm).discount = $event,
                    min: 0,
...
//# sourceMappingURL=Index-CCr6cy7j.js.map
