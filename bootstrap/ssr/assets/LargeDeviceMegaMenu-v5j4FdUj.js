            ...
            ssrRenderList(mainSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-cover"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
...
//# sourceMappingURL=LargeDeviceMegaMenu-v5j4FdUj.js.map
