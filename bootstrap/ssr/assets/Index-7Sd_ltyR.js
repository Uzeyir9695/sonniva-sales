...
import { _ as _sfc_main$1, s as script } from "./Breadcrumbs-DHQ88nK8.js";
import { ref, inject, watch, computed, unref, withCtx, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, renderList, withDirectives, vModelText, useSSRContext } from "vue";
...
import { _ as _sfc_main$4, a as _sfc_main$5 } from "./ItemsGrid-P57rKrAm.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="description"${ssrRenderAttr("content", `${__props.breadcrumbs?.at(-1)?.label} - იხილეთ Sonniva-ს სრული კატალოგი`)} data-v-04c5cf72${_scopeId}><meta property="og:type" content="website" data-v-04c5cf72${_scopeId}><meta property="og:site_name" content="Sonniva" data-v-04c5cf72${_scopeId}><meta property="og:title"${ssrRenderAttr("content", __props.breadcrumbs?.at(-1)?.label)} data-v-04c5cf72${_scopeId}><meta property="og:description"${ssrRenderAttr("content", `${__props.breadcrumbs?.at(-1)?.label} - იხილეთ Sonniva-ს სრული კატალოგი`)} data-v-04c5cf72${_scopeId}><meta property="og:url"${ssrRenderAttr("content", _ctx.$page.props.ziggy.location)} data-v-04c5cf72${_scopeId}><meta property="og:image"${ssrRenderAttr("content", `${_ctx.$page.props.ziggy.url}/logo/logo.png`)} data-v-04c5cf72${_scopeId}>`);
          } else {
            return [
              createVNode("meta", {
                name: "description",
      ...
      _push(`<div class="min-h-[calc(100vh-80px)] bg-[#f7f6f 3]" data-v-04c5cf72><div class="bg-white flex items-center justify-between sticky top-16 sm:top-20 z-20 sm:mt-4 sm:roun ded-t-xl shadow-xs" data-v-04c5cf72>`);
      _push(ssrRenderComponent(_sfc_main$1, { breadcrumbs: __props.breadcrumbs }, null, _parent));
      _push(`<button class="lg:hidden z-20 flex items-center gap-2 font-medium text-gray-700 border-l border-gray-200 sm:rounded-r-xl self-stretch px-3 hover:bg-gray-100 transition-colors" data-v-04c5cf72><i class="pi pi-sliders-h text-md" data-v-04c5cf72></i></button></div>`);
      if (activeChips.value?.length > 0) {
        _push(`<div class="${ssrRenderClass([activeChips.value?.length > 0 ? " justify-between" : "justify-end", "sm:hidden sticky top-28 z-20 bg-white border-b border-gray-100 px-2 py-1 flex items-center gap-2 shadow-sm"])}" data-v-04c5cf72>`);
      ...
      if (sidebarOpen.value) {
        _push(`<div class="fixed inset-0 bg-black/40 z-30 lg:hidden" data-v-04c5cf72></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      _push(`<div class="max-w-screen-2xl max-sm:mx-3 py-6 flex gap-6 relative" data-v-04c5cf72><div class="${ssrRenderClass([sidebarOpen.value ? "translate-x-0" : "-translate-x-full lg:translate-x-0", "max-lg:bg-white shrink-0 w-72 max-lg:pt-3 lg:block lg:sticky top-16 sm:top-20 lg:top-32 fixed left-0 h-full space-y-5 max-h-[calc(100vh-80px)] lg:max-h-[690px] overflow-x-hidden overflow-y-auto transition-all duration-300 z-40 lg:z-auto"])}" data-v-04c5cf72><button class="flex items-center ml-auto mr-2 text-gray-400 hover:text-gray-700 lg:hidden" data-v-04c5cf72><i class="pi pi-times" data-v-04c5cf72></i></button>`);
      if (__props.relatedCategories?.length) {
        _push(`<div class="bg-white max-sm:mx-2 border rounded-xl shadow-xs border-gray-100 px-5 py-3" data-v-04c5cf72>`);
        _push(ssrRenderComponent(_component_Panel, {
          ...
          header: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="text-sm font-bold text-gray-500" data-v-04c5cf72${_scopeId}>კატეგორიები</span>`);
            } else {
              return [
          ...
          toggleicon: withCtx(({ collapsed }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="${ssrRenderClass(["pi text-xs text-gray-400", collapsed ? "pi-chevron-down" : "pi-chevron-up"])}" data-v-04c5cf72${_scopeId}></i>`);
            } else {
              return [
                createVNode("i", {
            ...
            if (_push2) {
              if (__props.relatedCategoriesParent) {
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<i class="pi pi-th-large text-xs" data-v-04c5cf72${_scopeId2}></i> ${ssrInterpolate(__props.relatedCategoriesParent.name)}`);
                    } else {
                      return [
              ...
              ssrRenderList(__props.relatedCategories, (cat) => {
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<span data-v-04c5cf72${_scopeId2}>${ssrInterpolate(cat.name)}</span>`);
                      if (cat.slug === __props.currentCategorySlug) {
                        _push3(`<i class="pi pi-check text-xs text-brand-400" data-v-04c5cf72${_scopeId2}></i>`);
                      } else {
                        _push3(`<!---->`);
                      }
                    } else {
      ...
      _push(`<aside class="bg-white min-w-[288px] border max-lg:border-b-0 lg:rounded-2xl border-gray-100" data-v-04c5cf72><div class="px-5 py-6" data-v-04c5cf72><div class="items-center mt-2 justify-between mb-5 flex" data-v-04c5cf72><div class="items-center gap-x-1.5 flex" data-v-04c5cf72><i class="pi pi-sliders-h" data-v-04c5cf72></i><p class="text-xs font-semibold uppercase tracking-widest text-gray-400" data-v-04c5cf72>ფილტრი</p></div><div class="items-center gap-x-1 rounded-xl bg-slate-100 cursor-pointer px-2 py-1 flex" data-v-04c5cf72><i class="text-sm pi pi-refresh text-gray-500" data-v-04c5cf72></i><button class="text-xs text-gray-400 hover:text-gray-900 transition-colors" data-v-04c5cf72> გასუფთავება </button></div></div><div class="mb-4 border-b border-gray-100 pb-4" data-v-04c5cf72><p class="text-sm font-semibold text-gray-500 mb-3" data-v-04c5cf72>ფასი</p><div class="flex items-center gap-2" data-v-04c5cf72>`);
      ...
      _push(`<span class="text-gray-300 shrink-0" data-v-04c5cf72>—</span>`);
      _push(ssrRenderComponent(_component_InputNumber, {
      ...
      _push(`</div></div><div class="mb-4 border-b border-gray-100 pb-4" data-v-04c5cf72><p class="text-sm font-semibold text-gray-500 mb-3" data-v-04c5cf72>მარაგი</p>`);
      ...
      ssrRenderList(__props.attributes, (attr) => {
        _push(`<div class="mb-4 border-b border-gray-100 pb-4" data-v-04c5cf72>`);
        _push(ssrRenderComponent(_component_Panel, {
          header: attr.name,
          toggleable: "",
          collapsed: true
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (attr.values.length > 5) {
                _push2(`<div class="relative mb-3" data-v-04c5cf72${_scopeId}><input${ssrRenderAttr("value", attrSearch.value[attr.id])} type="text" placeholder="ძებნა..." class="w-full border border-gray-200 rounded-lg text-sm px-3 py-1.5 pr-7 outline-none focus:border-gray-400 bg-gray-50" data-v-04c5cf72${_scopeId}>`);
                if (attrSearch.value[attr.id]) {
                  _push2(`<i class="pi pi-times-circle absolute right-2 top-1/2 -translate-y-1/2 text-gray-400 cursor-pointer text-xs" data-v-04c5cf72${_scopeId}></i>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`</div>`);
              ...
              ssrRenderList(attr.values.filter(
                ...
                _push2(`<div class="flex items-center gap-2.5 mb-2" data-v-04c5cf72${_scopeId}>`);
                ...
                _push2(`<label${ssrRenderAttr("for", `attr-${attr.id}-${val}`)} class="text-sm text-gray-600 cursor-pointer hover:text-gray-900 transition-colors" data-v-04c5cf72${_scopeId}>${ssrInterpolate(val)}</label></div>`);
              });
              _push2(`<!--]-->`);
            } else {
              return [
      ...
      _push(`<!--]--></div></aside></div><div class="flex-1 min-w-0" data-v-04c5cf72>`);
      _push(ssrRenderComponent(_sfc_main$2, {
        chips: activeChips.value,
        onRemove: removeChip,
        onReset: resetFilters,
...
const Index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-04c5cf72"]]);
export {
  Index as default
};
//# sourceMappingURL=Index-7Sd_ltyR.js.map
