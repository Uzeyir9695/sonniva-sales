...
import { C as ConfirmationEventBus, s as script$4, _ as _sfc_main$1 } from "./index-Cnf5I2d0.js";
import { s as script$3 } from "./index-D46B4f3g.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const menuItems = computed(() => page.props.isPricingManager ? allMenuItems.value.filter((item) => item.route === "admin.items.index") : allMenuItems.value);
...
//# sourceMappingURL=AdminLayout-td1A5UZ_.js.map
