...
import { _ as _sfc_main$9, a as _sfc_main$a, u as useWishlist } from "./QuickViewDialog-DghRtzL9.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: rootRef,
        class: "relative"
      }, _attrs))}><button type="button" class="flex items-center justify-center md:w-8 md:h-8 lg:w-10 lg:h-10 rounded-full text-gray-600 hover:bg-gray-100 transition-all cursor-pointer"><img${ssrRenderAttr("src", flagMap[current.value])} class="w-7 h-5 object-cover border border-gray-200 rounded-sm" alt=""></button>`);
      if (open.value) {
        ...
        ssrRenderList(LOCALES, (locale) => {
          _push(`<button class="${ssrRenderClass([current.value === locale ? "text-brand-500 font-semibold bg-brand-50/50" : "text-gray-700", "w-full flex items-center gap-2.5 px-4 py-2.5 text-sm cursor-pointer hover:bg-gray-50 transition-colors"])}"><img${ssrRenderAttr("src", flagMap[locale])} class="w-5 h-3.5 border border-gray-200 object-cover rounded-xs shrink-0" alt=""><span>${ssrInterpolate(fullNameMap[locale])}</span>`);
...
//# sourceMappingURL=index-BLvIjj2O.js.map
