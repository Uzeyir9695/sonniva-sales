    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!selectedCategory.value) {
        ...
        if (unref(keywords).processing) {
          ...
          _push(`<div class="space-y-4"><div><label class="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1"><img${ssrRenderAttr("src", flagMap.ka)} class="w-5 h-3.5 object-cover rounded-xs shrink-0" alt=""> Georgian keywords </label>`);
          _push(ssrRenderComponent(_component_Textarea, {
            modelValue: unref(keywords).ka_keywords,
            "onUpdate:modelValue": ($event) => unref(keywords).ka_keywords = $event,
            rows: "3",
            class: "w-full rounded-xl text-sm",
            placeholder: "e.g. სლაიდერი, კარის საკეტი, სახელური"
          }, null, _parent));
          _push(`</div><div><label class="flex items-center gap-1.5 text-sm font-medium text-gray-700 mb-1"><img${ssrRenderAttr("src", flagMap.en)} class="w-5 h-3.5 object-cover rounded-xs shrink-0" alt=""> English keywords </label>`);
          _push(ssrRenderComponent(_component_Textarea, {
...
//# sourceMappingURL=ManageItemKeywordsTab-D_qP2Tve.js.map
