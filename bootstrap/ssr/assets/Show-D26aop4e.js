...
import _sfc_main$6 from "./SimilarItems-CXRFTyLw.js";
import _sfc_main$2 from "./ItemGallery-B72UFyX_.js";
import { b as _sfc_main$3, _ as _sfc_main$4 } from "./QuickViewDialog-8Z0R3wjt.js";
import { _ as _sfc_main$5 } from "./StockNotifyButton-BihFmX1g.js";
import { _ as _sfc_main$7 } from "./ItemCard-BfY1qubs.js";
...
import "./SwiperCarousel-SWdW-0J1.js";
import "swiper/vue";
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        unref(hasDiscount) ? {
          ...
          fn: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="absolute top-3 right-3 z-10 text-xs sm:text-sm font-bold px-3 py-1.5 rounded-full bg-red-500 text-white shadow-md"${_scopeId}> -${ssrInterpolate(Number(__props.item.discount))}% </span>`);
            } else {
              return [
                createVNode("span", { class: "absolute top-3 right-3 z-10 text-xs sm:text-sm font-bold px-3 py-1.5 rounded-full bg-red-500 text-white shadow-md" }, " -" + toDisplayString(Number(__props.item.discount)) + "% ", 1)
              ];
            }
          }),
          key: "0"
...
//# sourceMappingURL=Show-D26aop4e.js.map
