...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex flex-col items-center gap-y-6 rounded-lg bg-slate-200/30 sm:max-w-[500px] px-6 py-10 lg:py-16 mx-auto"><div class="text-lg sm:text-xl font-semibold">${ssrInterpolate(_ctx.$t("account.changePassword"))}</div>`);
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="current_password"${_scopeId}>${ssrInterpolate(_ctx.$t("account.currentPassword"))}</label>`);
          } else {
            return [
              ...
              createVNode("label", { for: "current_password" }, toDisplayString(_ctx.$t("account.currentPassword")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password"${_scopeId}>${ssrInterpolate(_ctx.$t("account.newPassword"))}</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                modelValue: unref(passwordForm).password,
              ...
              createVNode("label", { for: "password" }, toDisplayString(_ctx.$t("account.newPassword")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password_confirmation"${_scopeId}>${ssrInterpolate(_ctx.$t("account.repeatNewPassword"))}</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                modelValue: unref(passwordForm).password_confirmation,
              ...
              createVNode("label", { for: "password_confirmation" }, toDisplayString(_ctx.$t("account.repeatNewPassword")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Button, {
        ...
        label: unref(passwordForm).processing ? _ctx.$t("common.pleaseWait") : _ctx.$t("common.confirm"),
        text: "",
        raised: "",
        size: "small",
...
//# sourceMappingURL=UpdatePassword-w3MdUYUt.js.map
