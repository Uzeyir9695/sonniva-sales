    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("payment.tryAgain"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("payment.tryAgain")), 1)
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=Cancel-C9DGUJ5_.js.map
