...
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderClass, ssrGetDirectiveProps, ssrIncludeBooleanAttr } from "vue/server-renderer";
import { useForm, router } from "@inertiajs/vue3";
import { u as useToast } from "./index-Qb24q4w2.js";
import axios from "axios";
import { _ as _sfc_main$1 } from "./AdminLayout-yctIiIrP.js";
...
import "./QuickViewDialog-D7GVnYgy.js";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$1 }, {
  ...
  setup(__props) {
    ...
    function calcDiscountFromFakePrice() {
      ...
      manageForm.discount = Math.round((fakePrice - unitPrice) / fakePrice * 100 * 1e4) / 1e4;
    }
    function saveItem() {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_TabPanel, { value: "0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (searching.value) {
                          ...
                          ssrRenderList(results.value, (item) => {
                            ...
                            if (unref(getOriginalPrice)(item)) {
                              _push4(`<span class="text-red-500 line-through mr-1.5"${_scopeId3}>${ssrInterpolate(Number(unref(getOriginalPrice)(item)).toFixed(2))} ₾</span>`);
                            } else {
                              _push4(`<!---->`);
                            }
                            _push4(`<span class="font-semibold text-gray-700"${_scopeId3}>${ssrInterpolate(Number(unref(getDisplayPrice)(item)).toFixed(2))} ₾</span></p></div>`);
                            if (item.discount > 0) {
                        ...
                        _push4(`<hr class="my-6 border-gray-100"${_scopeId3}><div class="grid grid-cols-1 sm:grid-cols-2 gap-4"${_scopeId3}><div class="flex flex-col rounded-2xl border-2 border-emerald-200 bg-emerald-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-cloud-download"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Fetch New Items</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Fetches new items added in Business Central and adds them to the shop, with their category, images, prices and attributes. Existing items are left untouched. Leave the item number empty to check the full catalog, or enter one to fetch just that item. </p>`);
                        _push4(ssrRenderComponent(_sfc_main$2, {
                        ...
                        _push4(`<p class="text-sm text-gray-400 mt-3 flex items-center gap-1"${_scopeId3}><i class="pi pi-clock"${_scopeId3}></i>Seconds for a single item, about 4 minutes for the full catalog. </p></div><div class="flex flex-col rounded-2xl border-2 border-amber-200 bg-amber-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-tags"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Item Attributes</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Updates item attribute values (e.g. size, color) from Business Central. </p>`);
                        _push4(ssrRenderComponent(_component_Button, {
                        ...
                        _push4(`<p class="text-sm text-gray-400 mt-3 flex items-center gap-1"${_scopeId3}><i class="pi pi-clock"${_scopeId3}></i>Takes about 1-2 minutes to finish. </p></div><div class="flex flex-col rounded-2xl border-2 border-blue-200 bg-blue-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-box"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Inventory</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Updates item stock levels from Business Central and notifies users waiting on restocked items. </p>`);
                        _push4(ssrRenderComponent(_component_Button, {
                        ...
                        _push4(`<p class="text-sm text-gray-400 mt-3 flex items-center gap-1"${_scopeId3}><i class="pi pi-clock"${_scopeId3}></i>Takes about 1-2 minutes to finish. </p></div><div class="flex flex-col rounded-2xl border-2 border-purple-200 bg-purple-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-images"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Missing Item Images</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Fetches images from Business Central for in-stock items (inventory &gt; 0) that don&#39;t have any yet. Runs in the background. </p>`);
                        _push4(ssrRenderComponent(_component_Button, {
                        ...
                        _push4(`<p class="text-sm text-gray-400 mt-3 flex items-center gap-1"${_scopeId3}><i class="pi pi-clock"${_scopeId3}></i>Takes about 1-2 minutes to finish. </p></div></div>`);
                      } else {
                        return [
                              ...
                              return openBlock(), createBlock("li", {
                                ...
                                createVNode("div", { class: "flex-1 min-w-0" }, [
                                  ...
                                  createVNode("p", { class: "text-sm mt-0.5" }, [
                                    unref(getOriginalPrice)(item) ? (openBlock(), createBlock("span", {
                                      key: 0,
                                      class: "text-red-500 line-through mr-1.5"
                                    }, toDisplayString(Number(unref(getOriginalPrice)(item)).toFixed(2)) + " ₾", 1)) : createCommentVNode("", true),
                                    createVNode("span", { class: "font-semibold text-gray-700" }, toDisplayString(Number(unref(getDisplayPrice)(item)).toFixed(2)) + " ₾", 1)
                                  ])
                                ]),
                          ...
                          createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, [
                            createVNode("div", { class: "flex flex-col rounded-2xl border-2 border-emerald-200 bg-emerald-50/50 p-5" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center mb-3" }, [
                                createVNode("i", { class: "pi pi-cloud-download" })
                              ]),
                              createVNode("h2", { class: "text-base font-bold text-gray-900 mb-1" }, "Fetch New Items"),
                              createVNode("p", { class: "text-sm text-gray-500 mb-4" }, " Fetches new items added in Business Central and adds them to the shop, with their category, images, prices and attributes. Existing items are left untouched. Leave the item number empty to check the full catalog, or enter one to fetch just that item. "),
                              createVNode(_sfc_main$2, {
                                modelValue: itemNoToSync.value,
                                "onUpdate:modelValue": ($event) => itemNoToSync.value = $event,
                                size: "small",
                              ...
                              createVNode("p", { class: "text-sm text-gray-400 mt-3 flex items-center gap-1" }, [
                                createVNode("i", { class: "pi pi-clock" }),
                                createTextVNode("Seconds for a single item, about 4 minutes for the full catalog. ")
                              ])
                            ]),
                            createVNode("div", { class: "flex flex-col rounded-2xl border-2 border-amber-200 bg-amber-50/50 p-5" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center mb-3" }, [
                                createVNode("i", { class: "pi pi-tags" })
                              ]),
                              ...
                              createVNode("p", { class: "text-sm text-gray-400 mt-3 flex items-center gap-1" }, [
                                createVNode("i", { class: "pi pi-clock" }),
                                createTextVNode("Takes about 1-2 minutes to finish. ")
                              ])
                            ]),
                            createVNode("div", { class: "flex flex-col rounded-2xl border-2 border-blue-200 bg-blue-50/50 p-5" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mb-3" }, [
                                createVNode("i", { class: "pi pi-box" })
                              ]),
                              createVNode("h2", { class: "text-base font-bold text-gray-900 mb-1" }, "Inventory"),
                              createVNode("p", { class: "text-sm text-gray-500 mb-4" }, " Updates item stock levels from Business Central and notifies users waiting on restocked items. "),
                              createVNode(_component_Button, {
                                loading: syncingInventory.value,
                                onClick: syncInventory,
                                label: syncingInventory.value ? "Updating..." : "Sync Inventory",
                            ...
                            createVNode("div", { class: "flex flex-col rounded-2xl border-2 border-purple-200 bg-purple-50/50 p-5" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center mb-3" }, [
                                createVNode("i", { class: "pi pi-images" })
                              ]),
                              createVNode("h2", { class: "text-base font-bold text-gray-900 mb-1" }, "Missing Item Images"),
                              createVNode("p", { class: "text-sm text-gray-500 mb-4" }, " Fetches images from Business Central for in-stock items (inventory > 0) that don't have any yet. Runs in the background. "),
                              createVNode(_component_Button, {
                                loading: fetchingMissingImages.value,
                                onClick: fetchMissingImages,
                                label: fetchingMissingImages.value ? "Starting..." : "Fetch Missing Images",
                  ...
                  _push3(ssrRenderComponent(_component_TabPanel, { value: "1" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="grid grid-cols-1 sm:grid-cols-2 gap-4"${_scopeId3}><div class="flex flex-col rounded-2xl border-2 border-teal-200 bg-teal-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-sitemap"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Sync Categories</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Updates the category structure and item category codes from Business Central. </p>`);
                        _push4(ssrRenderComponent(_component_Button, {
                        ...
                        _push4(`<p class="text-sm text-gray-400 mt-3 flex items-center gap-1"${_scopeId3}><i class="pi pi-clock"${_scopeId3}></i>Takes about 1-2 minutes to finish. </p></div><div class="flex flex-col rounded-2xl border-2 border-pink-200 bg-pink-50/50 p-5"${_scopeId3}><div class="w-10 h-10 rounded-full bg-pink-100 text-pink-600 flex items-center justify-center mb-3"${_scopeId3}><i class="pi pi-image"${_scopeId3}></i></div><h2 class="text-base font-bold text-gray-900 mb-1"${_scopeId3}>Category Photo</h2><p class="text-sm text-gray-500 mb-4"${_scopeId3}> Search for a category by name or code and pull its latest photo from Business Central. The previous photo is deleted once the new one is saved. </p><span class="relative inline-block w-full"${_scopeId3}><i class="pi pi-search text-gray-400 text-sm absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none"${_scopeId3}></i>`);
                        _push4(ssrRenderComponent(_sfc_main$2, {
                        ...
                        if (searchingCategories.value) {
                          ...
                          _push4(`<ul class="divide-y divide-pink-100 mt-4"${_scopeId3}><!--[-->`);
                        ...
                        return [
                          createVNode("div", { class: "grid grid-cols-1 sm:grid-cols-2 gap-4" }, [
                            createVNode("div", { class: "flex flex-col rounded-2xl border-2 border-teal-200 bg-teal-50/50 p-5" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center mb-3" }, [
                                createVNode("i", { class: "pi pi-sitemap" })
                              ]),
                            ...
                            createVNode("div", { class: "flex flex-col rounded-2xl border-2 border-pink-200 bg-pink-50/50 p-5" }, [
                              createVNode("div", { class: "w-10 h-10 rounded-full bg-pink-100 text-pink-600 flex items-center justify-center mb-3" }, [
                              ...
                              createVNode("span", { class: "relative inline-block w-full" }, [
                                createVNode("i", { class: "pi pi-search text-gray-400 text-sm absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" }),
                                createVNode(_sfc_main$2, {
                                  modelValue: categoryQuery.value,
                                  "onUpdate:modelValue": ($event) => categoryQuery.value = $event,
                              ...
                              searchingCategories.value ? (openBlock(), createBlock("div", {
                                ...
                                key: 2,
                                class: "divide-y divide-pink-100 mt-4"
                              }, [
          ...
          if (_push2) {
            if (editingItem.value) {
              ...
              if (unref(manageForm).errors.bc_discount_percent) {
                ...
                _push2(`<p class="text-xs text-gray-400 mt-1"${_scopeId}>Percentage sent to Business Central on regular (non-wholesale/VIP) orders. Independent of the Web Discount above; leave empty to send no discount to BC.</p>`);
              }
              ...
              editingItem.value ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", null, [
                  ...
                  unref(manageForm).errors.bc_discount_percent ? (openBlock(), createBlock("p", {
                    ...
                    key: 1,
                    class: "text-xs text-gray-400 mt-1"
                  }, "Percentage sent to Business Central on regular (non-wholesale/VIP) orders. Independent of the Web Discount above; leave empty to send no discount to BC."))
                ]),
                createVNode("div", null, [
...
//# sourceMappingURL=Index-BgtcKCjF.js.map
