...
import { s as script$8 } from "./index-B9TXFrYE.js";
...
import { computed, ref, watch, unref, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderList } from "vue/server-renderer";
import { usePage, useForm, Head } from "@inertiajs/vue3";
import { u as useI18n } from "./vue-i18n-BvrxJaFX.js";
import _sfc_main$1 from "./UpdatePassword-w3MdUYUt.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>${ssrInterpolate(_ctx.$t("account.settingsTitle"))}</title>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(_ctx.$t("account.settingsTitle")), 1)
            ];
          }
        }),
        _: 1
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(_component_Tab, { value: "0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(_ctx.$t("account.profile"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(_ctx.$t("account.profile")), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  if (!__props.editingByAdmin) {
                    _push3(ssrRenderComponent(_component_Tab, { value: "1" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate(_ctx.$t("account.security"))}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(_ctx.$t("account.security")), 1)
                          ];
                        }
                      }),
                      _: 1
                  ...
                  _push3(ssrRenderComponent(_component_TabPanel, { value: "0" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(`<form class="w-full space-y-6 py-6"${_scopeId3}><div class="grid grid-cols-1 w-full max-w-md mx-auto gap-y-6"${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_FloatLabel, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<label for="name"${_scopeId4}>${ssrInterpolate(_ctx.$t("account.firstName"))}</label>`);
                            } else {
                              return [
                                ...
                                createVNode("label", { for: "name" }, toDisplayString(_ctx.$t("account.firstName")), 1)
                              ];
                            }
                          }),
                          _: 1
                          ...
                          _push4(ssrRenderComponent(_component_FloatLabel, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<label for="lastname"${_scopeId4}>${ssrInterpolate(_ctx.$t("account.lastName"))}</label>`);
                              } else {
                                return [
                                  createVNode(_component_InputText, {
                                    class: "w-full",
                                  ...
                                  createVNode("label", { for: "lastname" }, toDisplayString(_ctx.$t("account.lastName")), 1)
                                ];
                              }
                            }),
                            _: 1
                          ...
                          _push4(ssrRenderComponent(_component_FloatLabel, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<label for="tax_id"${_scopeId4}>${ssrInterpolate(selectedUserType.value?.key === "legal_entity" ? _ctx.$t("account.taxId") : _ctx.$t("account.idNumber"))}</label>`);
                              } else {
                                return [
                                  createVNode(_component_InputText, {
                                    class: "w-full",
                                  ...
                                  createVNode("label", { for: "tax_id" }, toDisplayString(selectedUserType.value?.key === "legal_entity" ? _ctx.$t("account.taxId") : _ctx.$t("account.idNumber")), 1)
                                ];
                              }
                            }),
                            _: 1
                        ...
                        _push4(ssrRenderComponent(_component_FloatLabel, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<label for="phone"${_scopeId4}>${ssrInterpolate(_ctx.$t("account.phone"))}</label>`);
                            } else {
                              return [
                                createVNode(_component_InputText, {
                                  class: "w-full",
                                ...
                                createVNode("label", { for: "phone" }, toDisplayString(_ctx.$t("account.phone")), 1)
                              ];
                            }
                          }),
                          _: 1
                        ...
                        _push4(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<label for="email"${_scopeId4}>${ssrInterpolate(_ctx.$t("account.email"))}</label>`);
                            } else {
                              return [
                                createVNode(_component_InputText, {
                                  class: "w-full",
                                ...
                                createVNode("label", { for: "email" }, toDisplayString(_ctx.$t("account.email")), 1)
                              ];
                            }
                          }),
                          _: 1
                          ...
                          _push4(ssrRenderComponent(_component_FloatLabel, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<label for="address"${_scopeId4}>${ssrInterpolate(_ctx.$t("account.address"))}</label>`);
                              } else {
                                return [
                                  createVNode(_component_InputText, {
                                    class: "w-full",
                                  ...
                                  createVNode("label", { for: "address" }, toDisplayString(_ctx.$t("account.address")), 1)
                                ];
                              }
                            }),
                            _: 1
                          ...
                          _push4(ssrRenderComponent(_component_FloatLabel, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<label for="user_type"${_scopeId4}>${ssrInterpolate(_ctx.$t("account.userType"))}</label>`);
                              } else {
                                return [
                                  ...
                                  createVNode("label", { for: "user_type" }, toDisplayString(_ctx.$t("account.userType")), 1)
                                ];
                              }
                            }),
                            _: 1
                        ...
                        if (__props.editingByAdmin) {
                          _push4(`<div class="space-y-2"${_scopeId3}><p class="text-sm sm:text-lg font-bold text-gray-500 mb-1"${_scopeId3}>Permissions</p><div class="flex items-center gap-2"${_scopeId3}>`);
                          ...
                          _push4(`<label for="ingredient1"${_scopeId3}> Can view wholesales </label></div><div class="flex items-center gap-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Checkbox, {
                            modelValue: unref(form).can_view_vip,
                            "onUpdate:modelValue": ($event) => unref(form).can_view_vip = $event,
                            binary: ""
                          }, null, _parent4, _scopeId3));
                          _push4(`<label for="ingredient1"${_scopeId3}> Can view VIP prices </label></div><div class="flex items-center gap-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Checkbox, {
                            modelValue: unref(form).can_view_inventory,
                            "onUpdate:modelValue": ($event) => unref(form).can_view_inventory = $event,
                            binary: ""
                          }, null, _parent4, _scopeId3));
                          _push4(`<label for="ingredient1"${_scopeId3}> Can view inventory </label></div><div class="flex items-center gap-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Checkbox, {
                            modelValue: unref(form).allow_cash_payment,
                            "onUpdate:modelValue": ($event) => unref(form).allow_cash_payment = $event,
                            binary: ""
                          }, null, _parent4, _scopeId3));
                          _push4(`<label for="ingredient1"${_scopeId3}> Allow cash payment </label></div><div class="flex items-center gap-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Checkbox, {
                            modelValue: unref(form).has_free_delivery,
                            "onUpdate:modelValue": ($event) => unref(form).has_free_delivery = $event,
                            binary: ""
                          }, null, _parent4, _scopeId3));
                          _push4(`<label for="ingredient1"${_scopeId3}> Has free delivery </label></div><div class="flex items-center gap-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Checkbox, {
                            modelValue: unref(form).is_entrepreneur,
                            "onUpdate:modelValue": ($event) => unref(form).is_entrepreneur = $event,
                            binary: ""
                          }, null, _parent4, _scopeId3));
                          _push4(`<label for="ingredient1"${_scopeId3}> Is entrepreneur </label></div><div class="flex items-center gap-2"${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_Checkbox, {
                            modelValue: unref(form).is_handyman,
                            "onUpdate:modelValue": ($event) => unref(form).is_handyman = $event,
                            binary: ""
                          }, null, _parent4, _scopeId3));
                          _push4(`<label for="ingredient1"${_scopeId3}> Is handyman </label></div></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        _push4(ssrRenderComponent(_component_Button, {
                          ...
                          label: unref(form).processing ? _ctx.$t("common.pleaseWait") : _ctx.$t("common.save"),
                          size: "small",
                          icon: unref(form).processing ? "pi pi-spin pi-spinner" : "pi pi-check"
                        }, null, _parent4, _scopeId3));
                        _push4(`</div></form>`);
                      } else {
                        return [
                          ...
                          createVNode("form", {
                            ...
                            createVNode("div", { class: "grid grid-cols-1 w-full max-w-md mx-auto gap-y-6" }, [
                              ...
                              __props.editingByAdmin ? (openBlock(), createBlock("div", {
                                key: 4,
                                class: "space-y-2"
                              }, [
                                createVNode("p", { class: "text-sm sm:text-lg font-bold text-gray-500 mb-1" }, "Permissions"),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Can view wholesales ")
                                ]),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  createVNode(_component_Checkbox, {
                                    modelValue: unref(form).can_view_vip,
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Can view VIP prices ")
                                ]),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  createVNode(_component_Checkbox, {
                                    modelValue: unref(form).can_view_inventory,
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Can view inventory ")
                                ]),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  createVNode(_component_Checkbox, {
                                    modelValue: unref(form).allow_cash_payment,
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Allow cash payment ")
                                ]),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  createVNode(_component_Checkbox, {
                                    modelValue: unref(form).has_free_delivery,
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Has free delivery ")
                                ]),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  createVNode(_component_Checkbox, {
                                    modelValue: unref(form).is_entrepreneur,
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Is entrepreneur ")
                                ]),
                                createVNode("div", { class: "flex items-center gap-2" }, [
                                  createVNode(_component_Checkbox, {
                                    modelValue: unref(form).is_handyman,
                                  ...
                                  createVNode("label", { for: "ingredient1" }, " Is handyman ")
                                ])
                              ])) : createCommentVNode("", true),
...
//# sourceMappingURL=Index-CXaqGDGK.js.map
