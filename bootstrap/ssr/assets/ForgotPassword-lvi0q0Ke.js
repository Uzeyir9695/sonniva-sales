    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>${ssrInterpolate(_ctx.$t("auth.forgotTitle"))}</title>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(_ctx.$t("auth.forgotTitle")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="bg-white flex flex-col justify-evenly mx-3 sm:mx-auto shadow-lg rounded-xl border border-slate-200 mt-8 w-full sm:w-[450px] h-[400px]"><form class="flex flex-col p-8 gap-6 self-center"><p class="text-center">${ssrInterpolate(_ctx.$t("auth.forgotHint"))}</p><!--[-->`);
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="email"${_scopeId}>${ssrInterpolate(_ctx.$t("auth.phone"))}</label>`);
          } else {
            return [
              ...
              createVNode("label", { for: "email" }, toDisplayString(_ctx.$t("auth.phone")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Button, {
        ...
        label: unref(form).processing ? _ctx.$t("common.pleaseWait") : _ctx.$t("common.continue"),
        size: "medium",
...
//# sourceMappingURL=ForgotPassword-lvi0q0Ke.js.map
