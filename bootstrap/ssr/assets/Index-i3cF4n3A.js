import { computed, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext, ref, toDisplayString, createTextVNode, resolveDynamicComponent } from "vue";
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-cols-5 gap-3 px-4 h-[calc(100vh-100px)]" }, _attrs))}>`);
      if (mainSrc.value.length) {
        _push(`<div class="col-span-5 xl:col-span-3 xl:row-span-2 h-full relative rounded-xl overflow-hidden">`);
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      if (slide.item_slug) {
                        _push3(ssrRenderComponent(unref(Link), {
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              _push4(`<img${ssrRenderAttr("src", slide.image_url)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-cover sm:object-contain"${_scopeId3}></picture>`);
                            } else {
                              return [
                        ...
                        _push3(`<img${ssrRenderAttr("src", slide.image_url)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-cover sm:object-contain"${_scopeId2}></picture>`);
                      }
                    } else {
                      return [
      ...
      _push(`<div class="col-span-5 xl:col-span-2 h-full relative rounded-xl overflow-hidden">`);
      _push(ssrRenderComponent(unref(Swiper), {
        modules,
        "slides-per-view": 1,
...
//# sourceMappingURL=Index-i3cF4n3A.js.map
