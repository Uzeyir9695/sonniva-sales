...
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrRenderTeleport, ssrGetDirectiveProps } from "vue/server-renderer";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: rootRef,
        class: "relative"
      }, _attrs))}><button type="button" class="flex items-center justify-center md:w-8 md:h-8 lg:w-10 lg:h-10 gap-1.5 rounded-full text-gray-600 hover:bg-gray-100 transition-all cursor-pointer"><span class="text-sm font-semibold tracking-wide">${ssrInterpolate(current.value.toUpperCase())}</span></button>`);
      if (open.value) {
...
//# sourceMappingURL=index-D_tUtrFw.js.map
