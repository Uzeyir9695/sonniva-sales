...
/* empty css                    */
import { _ as _sfc_main$3 } from "./SwiperCarousel-Dj9nYNbp.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Swiper), {
        ...
        autoplay: mainSrc.value.length > 1 ? { delay: 5e3, disableOnInteraction: false } : false,
        class: "h-full w-full"
      }, {
            ...
            ssrRenderList(mainSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-cover sm:object-contain"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
          ...
          if (_push2) {
            ...
            ssrRenderList(doorSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `door ${i + 1}`)} class="w-full h-full object-cover sm:object-contain"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
          ...
          if (_push2) {
            ...
            ssrRenderList(frameSrc.value, (src, i) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<img${ssrRenderAttr("src", src)}${ssrRenderAttr("alt", `frame ${i + 1}`)} class="w-full h-full object-cover sm:object-contain"${_scopeId2}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src,
...
//# sourceMappingURL=Index-BYaUpHiQ.js.map
