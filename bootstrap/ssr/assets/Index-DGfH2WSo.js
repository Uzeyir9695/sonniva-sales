import { unref, withCtx, createVNode, openBlock, createBlock, toDisplayString, useSSRContext } from "vue";
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), {
        title: _ctx.$t("sales.title")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<meta name="description"${ssrRenderAttr("content", _ctx.$t("sales.metaDescription"))}${_scopeId}>`);
          } else {
            return [
              createVNode("meta", {
                name: "description",
                content: _ctx.$t("sales.metaDescription")
              }, null, 8, ["content"])
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(unref(Deferred), { data: "items" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.items.data?.length) {
              ...
              _push2(`<div class="flex flex-col items-center justify-center h-72 text-center"${_scopeId}><div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center mb-4"${_scopeId}><i class="pi pi-percentage text-3xl text-gray-300"${_scopeId}></i></div><h3 class="text-lg font-medium text-gray-500"${_scopeId}>${ssrInterpolate(_ctx.$t("sales.empty"))}</h3></div>`);
            }
          } else {
            return [
              __props.items.data?.length ? (openBlock(), createBlock(_sfc_main$2, {
                ...
                createVNode("h3", { class: "text-lg font-medium text-gray-500" }, toDisplayString(_ctx.$t("sales.empty")), 1)
              ]))
            ];
          }
        }),
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$1, { "is-sale-page": "" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$1, { "is-sale-page": "" })
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=Index-DGfH2WSo.js.map
