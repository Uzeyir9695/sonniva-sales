...
import { s as script } from "./index-D4V0SHH2.js";
import { ref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ Object.assign({ layout: _sfc_main$1 }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="p-6"><div class="flex items-center justify-between mb-6"><div><h1 class="text-xl font-bold text-gray-900">Stock Notifications</h1><p class="text-sm text-gray-500 mt-0.5">Users waiting for products to be restocked</p></div></div><div class="flex gap-2 mb-5"><button class="${ssrRenderClass([__props.tab === "pending" ? "bg-amber-100 text-amber-700" : "bg-gray-100 text-gray-500 hover:bg-gray-200", "flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors cursor-pointer"])}"><i class="pi pi-clock text-xs"></i> Pending <span class="${ssrRenderClass([__props.tab === "pending" ? "bg-amber-200 text-amber-800" : "bg-gray-200 text-gray-600", "text-xs font-bold px-1.5 py-0.5 rounded-full"])}">${ssrInterpolate(__props.counts.pending)}</span></button><button class="${ssrRenderClass([__props.tab === "sent" ? "bg-emerald-100 text-emerald-700" : "bg-gray-100 text-gray-500 hover:bg-gray-200", "flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors cursor-pointer"])}"><i class="pi pi-check-circle text-xs"></i> Sent <span class="${ssrRenderClass([__props.tab === "sent" ? "bg-emerald-200 text-emerald-800" : "bg-gray-200 text-gray-600", "text-xs font-bold px-1.5 py-0.5 rounded-full"])}">${ssrInterpolate(__props.counts.sent)}</span></button></div>`);
...
//# sourceMappingURL=Index-871gaK60.js.map
