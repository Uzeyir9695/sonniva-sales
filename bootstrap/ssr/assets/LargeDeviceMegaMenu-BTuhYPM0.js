...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-cols-5 grid-rows-[1fr_1fr_auto] gap-3 px-4 h-[calc(100vh-100px)]" }, _attrs))}><div class="hidden xl:block col-span-3 row-span-2 relative rounded-xl overflow-hidden"><img src="/frame-examples/fur1.jpeg" alt="frame" class="w-full h-full object-cover"></div><div class="col-span-5 xl:col-span-2 h-full relative rounded-xl overflow-hidden">`);
...
//# sourceMappingURL=LargeDeviceMegaMenu-BTuhYPM0.js.map
