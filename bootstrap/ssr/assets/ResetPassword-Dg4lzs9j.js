    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>${ssrInterpolate(_ctx.$t("auth.resetTitle"))}</title>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(_ctx.$t("auth.resetTitle")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<div class="px-2.5 sm:px-0"><div class="bg-white flex flex-col justify-evenly sm:mx-auto shadow-lg rounded-xl border border-slate-200 mt-8 w-full max-w-[450px] h-100"><form class="flex flex-col p-8 gap-6 self-center w-full"><div class="flex flex-col space-y-5"><div class="self-center text-2xl font-semibold">${ssrInterpolate(_ctx.$t("auth.newPassword"))}</div></div>`);
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="phone"${_scopeId}>${ssrInterpolate(_ctx.$t("auth.phone"))}</label>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password"${_scopeId}>${ssrInterpolate(_ctx.$t("auth.newPassword"))}</label>`);
          } else {
            return [
              ...
              createVNode("label", { for: "password" }, toDisplayString(_ctx.$t("auth.newPassword")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_FloatLabel, { variant: "on" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<label for="password_confirmation"${_scopeId}>${ssrInterpolate(_ctx.$t("auth.repeatNewPassword"))}</label>`);
          } else {
            return [
              createVNode(_component_Password, {
                toggleMask: "",
              ...
              createVNode("label", { for: "password_confirmation" }, toDisplayString(_ctx.$t("auth.repeatNewPassword")), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_Button, {
        ...
        label: unref(form).processing ? _ctx.$t("common.pleaseWait") : _ctx.$t("auth.confirm"),
        size: "medium",
...
//# sourceMappingURL=ResetPassword-Dg4lzs9j.js.map
