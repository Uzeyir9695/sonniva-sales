...
import { ref, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, mergeProps, withDirectives, createCommentVNode, useSSRContext } from "vue";
...
import _sfc_main$1 from "./OrderDetailDialog-BI-t10sZ.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.orders?.data?.some((o) => o.tracking_number)) {
              _push2(`<div class="flex items-center gap-2 bg-blue-50 text-blue-700 text-sm px-4 py-3 mb-4 rounded-xl"${_scopeId}><i class="pi pi-info-circle"${_scopeId}></i><span${_scopeId}>შეკვეთის სტატუსის სანახავად დააკოპირეთ თრექინგის ნომერი და მოძებნეთ Onway-ის საიტზე:</span><a href="https://onway.ge/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-1 font-semibold underline shrink-0"${_scopeId}> ვებგვერდზე გადასვლა <i class="pi pi-external-link text-xs"${_scopeId}></i></a></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              __props.orders?.data?.some((o) => o.tracking_number) ? (openBlock(), createBlock("div", {
                ...
                createVNode("span", null, "შეკვეთის სტატუსის სანახავად დააკოპირეთ თრექინგის ნომერი და მოძებნეთ Onway-ის საიტზე:"),
                createVNode("a", {
                  href: "https://onway.ge/",
                  target: "_blank",
                  rel: "noopener noreferrer",
                  class: "flex items-center gap-1 font-semibold underline shrink-0"
                }, [
                  createTextVNode(" ვებგვერდზე გადასვლა "),
...
//# sourceMappingURL=Index-DNFqYAnD.js.map
