import { ref, onMounted, computed, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext, toDisplayString, createTextVNode, resolveDynamicComponent } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderTeleport, ssrRenderClass, ssrGetDirectiveProps, ssrRenderVNode } from "vue/server-renderer";
...
import { _ as _sfc_main$4 } from "./SwiperCarousel-A5hvVlR1.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (mainSrc.value.length) {
        _push(`<div class="relative rounded-xl overflow-hidden min-h-0 max-sm:h-60">`);
        if (mounted.value) {
                        ...
                        if (slide.item_slug) {
                          _push3(ssrRenderComponent(unref(Link), {
                            ...
                            default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                              if (_push4) {
                                _push4(`<picture class="block h-full w-full"${_scopeId3}>`);
                                if (slide.mobile_image_url) {
                                  _push4(`<source${ssrRenderAttr("srcset", slide.mobile_image_url)} media="(max-width: 639px)"${_scopeId3}>`);
                                } else {
                                  _push4(`<!---->`);
                                }
                                _push4(`<img${ssrRenderAttr("src", slide.image_url)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-cover"${_scopeId3}></picture>`);
                              } else {
                                return [
                                  createVNode("picture", { class: "block h-full w-full" }, [
                          ...
                          _push3(`<picture class="block h-full w-full"${_scopeId2}>`);
                          if (slide.mobile_image_url) {
                            _push3(`<source${ssrRenderAttr("srcset", slide.mobile_image_url)} media="(max-width: 639px)"${_scopeId2}>`);
                          } else {
                            _push3(`<!---->`);
                          }
                          _push3(`<img${ssrRenderAttr("src", slide.image_url)}${ssrRenderAttr("alt", `main ${i + 1}`)} class="w-full h-full object-cover"${_scopeId2}></picture>`);
                        }
                      } else {
                        return [
                          slide.item_slug ? (openBlock(), createBlock(unref(Link), {
                            ...
                            _: 2
                          }, 1032, ["href"])) : (openBlock(), createBlock("picture", {
                            key: 1,
                            class: "block h-full w-full"
                          }, [
                            slide.mobile_image_url ? (openBlock(), createBlock("source", {
          ...
          _push(`<img${ssrRenderAttr("src", mainSrc.value[0].image_url)} alt="main" class="w-full h-full object-cover">`);
        }
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="grid grid-cols-1 sm:grid-cols-2 gap-3 min-h-0"><div class="relative rounded-xl overflow-hidden min-h-0 max-sm:h-56">`);
      if (mounted.value) {
        _push(ssrRenderComponent(unref(Swiper), {
          modules,
          "slides-per-view": 1,
...
//# sourceMappingURL=Index-9rt5AYVc.js.map
